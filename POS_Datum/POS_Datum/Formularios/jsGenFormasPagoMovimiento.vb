...
Public Class jsGenFormasPagoMovimiento
    ...
    Private Sub IniciarTXT()
        ...
        ft.RellenaCombo(aFormaPago, cmbFP, 0)
    ...
    Private Function Validado() As Boolean
        ...
        If ValorNumero(txtImporte.Text) > MontoRestante Then
    ...
    Private Sub cmbFP_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbFP.SelectedIndexChanged
        ...
        If i_modo = movimiento.iAgregar Then
            ...
            CalculaIVA(aFormaPagoAbreviada(cmbFP.SelectedIndex))
            ...
            txtImporte.Text = ft.muestraCampoNumero(totalAPagar - subTotalPagos)
