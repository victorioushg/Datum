...
Public Class rptGENTablaSimple
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesGenerales.rptGENTablaSimple.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGENTablaSimple
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGENTablaSimple = New rptGENTablaSimple()
        rpt.Site = Me.Site
        Return rpt
    End Function
