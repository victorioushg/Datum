...
Public Class rptBanDepositos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeBancos.rptBanDepositos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBanDepositos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBanDepositos = New rptBanDepositos()
        rpt.Site = Me.Site
        Return rpt
    End Function
