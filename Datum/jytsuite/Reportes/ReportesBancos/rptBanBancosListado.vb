...
Public Class rptBanBancosListado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBanBancosListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeBancos.rptBanBancosListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBanBancosListado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBanBancosListado = New rptBanBancosListado()
        rpt.Site = Me.Site
        Return rpt
    End Function
