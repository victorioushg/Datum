...
Public Class rptBanBancosIDB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeBancos.rptBanBancosIDB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBanBancosIDB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBanBancosIDB = New rptBanBancosIDB()
        rpt.Site = Me.Site
        Return rpt
    End Function
