...
Public Class rptBanBancosFicha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeBancos.rptBanBancosFicha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBanBancosFicha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBanBancosFicha = New rptBanBancosFicha()
        rpt.Site = Me.Site
        Return rpt
    End Function
