...
Public Class rptBanCajaCierre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeBancos.rptBanCajaCierre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBanCajaCierre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBanCajaCierre = New rptBanCajaCierre()
        rpt.Site = Me.Site
        Return rpt
    End Function
