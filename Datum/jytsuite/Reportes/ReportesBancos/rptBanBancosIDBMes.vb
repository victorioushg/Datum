...
Public Class rptBanBancosIDBMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeBancos.rptBanBancosIDBMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBanBancosIDBMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBanBancosIDBMes = New rptBanBancosIDBMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
