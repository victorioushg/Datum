...
Public Class rptContabReglas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeContabilidad.rptContabReglas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContabReglas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContabReglas = New rptContabReglas()
        rpt.Site = Me.Site
        Return rpt
    End Function
