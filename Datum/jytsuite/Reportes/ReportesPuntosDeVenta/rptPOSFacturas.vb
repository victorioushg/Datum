...
Public Class rptPOSFacturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDePuntosDeVentas.rptPOSFacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPOSFacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPOSFacturas = New rptPOSFacturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
