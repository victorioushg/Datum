...
Public Class rptGENRelacionCT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesGenerales.rptGENRelacionCT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGENRelacionCT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGENRelacionCT = New rptGENRelacionCT()
        rpt.Site = Me.Site
        Return rpt
    End Function
