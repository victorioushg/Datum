...
Public Class rptGENFormaDePago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesGenerales.rptGENFormaDePago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGENFormaDePago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGENFormaDePago = New rptGENFormaDePago()
        rpt.Site = Me.Site
        Return rpt
    End Function
