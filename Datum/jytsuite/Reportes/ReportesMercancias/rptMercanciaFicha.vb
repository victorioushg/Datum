...
Public Class rptMercanciaFicha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeMercancias.rptMercanciaFicha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMercanciaFicha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMercanciaFicha = New rptMercanciaFicha()
        rpt.Site = Me.Site
        Return rpt
    End Function
