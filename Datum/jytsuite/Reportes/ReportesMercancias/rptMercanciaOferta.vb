...
Public Class rptMercanciaOferta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeMercancias.rptMercanciaOferta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMercanciaOferta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMercanciaOferta = New rptMercanciaOferta()
        rpt.Site = Me.Site
        Return rpt
    End Function
