...
Public Class rptMercanciaServiciosMovimientos0G
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMercanciaServiciosMovimientos0G.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Datum.rptMercanciaServiciosMovimientos0G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMercanciaServiciosMovimientos0G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMercanciaServiciosMovimientos0G = New rptMercanciaServiciosMovimientos0G()
        rpt.Site = Me.Site
        Return rpt
    End Function
