...
Public Class rptMercanciaBarra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeMercancias.rptMercanciaBarra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMercanciaBarra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMercanciaBarra = New rptMercanciaBarra()
        rpt.Site = Me.Site
        Return rpt
    End Function
