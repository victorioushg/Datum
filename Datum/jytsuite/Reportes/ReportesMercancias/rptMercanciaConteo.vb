...
Public Class rptMercanciaConteo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeMercancias.rptMercanciaConteo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_numConteo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMercanciaConteo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMercanciaConteo = New rptMercanciaConteo()
        rpt.Site = Me.Site
        Return rpt
    End Function
