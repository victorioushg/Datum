...
Public Class rptVentasSaldos3G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasSaldos3G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasSaldos3G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasSaldos3G = New rptVentasSaldos3G()
        rpt.Site = Me.Site
        Return rpt
    End Function
