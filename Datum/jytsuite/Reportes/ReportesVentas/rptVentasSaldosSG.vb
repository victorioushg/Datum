...
Public Class rptVentasSaldosSG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Datum.rptVentasSaldosSG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasSaldosSG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasSaldosSG = New rptVentasSaldosSG()
        rpt.Site = Me.Site
        Return rpt
    End Function
