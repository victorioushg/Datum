...
Public Class rptVentasAsesor0G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Datum.rptVentasAsesor0G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasAsesor0G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasAsesor0G = New rptVentasAsesor0G()
        rpt.Site = Me.Site
        Return rpt
    End Function
