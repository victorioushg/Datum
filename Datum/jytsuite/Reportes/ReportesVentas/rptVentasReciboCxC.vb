...
Public Class rptVentasReciboCxC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasReciboCxC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasReciboCxC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasReciboCxC = New rptVentasReciboCxC()
        rpt.Site = Me.Site
        Return rpt
    End Function
