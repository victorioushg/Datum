...
Public Class rptVentasSaldos2G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasSaldos2G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasSaldos2G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasSaldos2G = New rptVentasSaldos2G()
        rpt.Site = Me.Site
        Return rpt
    End Function
