...
Public Class rptVentasRutas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasRutas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasRutas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasRutas = New rptVentasRutas()
        rpt.Site = Me.Site
        Return rpt
    End Function
