...
Public Class rptVentasSaldos0G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasSaldos0G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasSaldos0G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasSaldos0G = New rptVentasSaldos0G()
        rpt.Site = Me.Site
        Return rpt
    End Function
