...
Public Class rptVentasRanking4G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasRanking4G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasRanking4G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasRanking4G = New rptVentasRanking4G()
        rpt.Site = Me.Site
        Return rpt
    End Function
