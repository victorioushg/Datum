...
Public Class rptVentasRanking1G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasRanking1G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasRanking1G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasRanking1G = New rptVentasRanking1G()
        rpt.Site = Me.Site
        Return rpt
    End Function
