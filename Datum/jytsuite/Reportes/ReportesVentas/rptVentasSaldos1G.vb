...
Public Class rptVentasSaldos1G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasSaldos1G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasSaldos1G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasSaldos1G = New rptVentasSaldos1G()
        rpt.Site = Me.Site
        Return rpt
    End Function
