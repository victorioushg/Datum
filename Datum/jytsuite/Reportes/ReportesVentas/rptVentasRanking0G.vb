...
Public Class rptVentasRanking0G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasRanking0G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasRanking0G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasRanking0G = New rptVentasRanking0G()
        rpt.Site = Me.Site
        Return rpt
    End Function
