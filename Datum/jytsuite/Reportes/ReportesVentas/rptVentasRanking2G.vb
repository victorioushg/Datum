...
Public Class rptVentasRanking2G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasRanking2G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasRanking2G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasRanking2G = New rptVentasRanking2G()
        rpt.Site = Me.Site
        Return rpt
    End Function
