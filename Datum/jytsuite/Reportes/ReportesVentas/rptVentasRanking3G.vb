...
Public Class rptVentasRanking3G
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeVentas.rptVentasRanking3G.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasRanking3G
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasRanking3G = New rptVentasRanking3G()
        rpt.Site = Me.Site
        Return rpt
    End Function
