...
Public Class rptNominaFirmas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Datum.rptNominaFirmas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNominaFirmas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNominaFirmas = New rptNominaFirmas()
        rpt.Site = Me.Site
        Return rpt
    End Function
