...
Public Class rptNominaConceptos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesDeNomina.rptNominaConceptos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNominaConceptos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNominaConceptos = New rptNominaConceptos()
        rpt.Site = Me.Site
        Return rpt
    End Function
