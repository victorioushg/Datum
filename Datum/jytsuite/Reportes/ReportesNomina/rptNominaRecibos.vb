...
Public Class rptNominaRecibos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Datum.rptNominaRecibos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNominaRecibos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNominaRecibos = New rptNominaRecibos()
        rpt.Site = Me.Site
        Return rpt
    End Function
