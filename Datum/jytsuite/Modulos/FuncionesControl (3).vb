...
Module FuncionesControl
    ...
    Public Sub IniciarParametros(ByVal Myconn As MySqlConnection, ByVal lblInfo As Label)
        If ExisteTabla(Myconn, jytsistema.WorkDataBase, "jsconparametros", lblInfo) Then
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM08", "2.01 Al realizar movimiento en cheque REGISTRAR asiento contable obligatoriamente ...", TipoParametro.iNoSi, 1)
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM07", "0.10 ¿Al cancelar facturas pendientes desbloquear cliente si este posee cheques devueltos sin cancelar?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM08", "0.11 ¿Habilitar ventana de impresión de facturas en guía de despacho?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM09", "0.12 ¿Valida tickets en cancelaciones de cheques de alimentación?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM10", "0.13 ¿Puede ser el monto de cancelaciones mayor al monto dado por documentos seleccionados?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM11", "0.14 Indique número de caja por defecto para cancelar CXC con cheques de alimentación ...", TipoParametro.iCadena, "00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM12", "0.15 Indique número de caja por defecto para cancelar CXC en efectivo..", TipoParametro.iCadena, "00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM13", "0.16 Indique número de caja por defecto para cancelar CXC con cheques ...", TipoParametro.iCadena, "00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM14", "0.17 Indique número de caja por defecto para cancelar CXC con tarjetas de débito y/o crédito ...", TipoParametro.iCadena, "00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM15", "0.18 Porcentaje retención de Impuesto al Valor Agregado (IVA) ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM16", "0.19 ¿Valida el peso máximo de carga de los camiones contra el peso estimado en la guía de carga?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM17", "0.20 ¿Permite cancelar con cheques fechados a futuro (Post Date)?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM18", "0.21 Cantidad de días de post date para cheques fechados a futuro", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM19", "0.22 ¿Permite facturar si el cliente posee cheques fechados a futuro? ...", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM20", "0.23 Porcentaje de interés simple ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM21", "0.24 Porcentaje de interés compuesto ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM22", "0.25 Porcentaje de interés de mora ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM23", "0.26 Calcula cuotas de giros y/o reconversión de deuda en base al interes compuesto...", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM24", "0.27 ¿Proceso de BLOQUEO de clientes automático?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM25", "0.28 ¿Bloquear incluir Notas de Crédito cuyo origen es CXC?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM26", "0.29 ¿Pide y valida Número de Depósito Bancario en proceso de pre-cancelaciones a cancelaciones ?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM27", "0.30 Ruta de Visita inicial para el registro de cliente nuevo ...", TipoParametro.iCadena, "")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM28", "0.31 Origen del NUMERO DE CONTROL (0=registro, 1=contador, 2=Máquina Fiscal, 3=Contador Anterior) ...", TipoParametro.iEntero, "2")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 1, "VENCOTPA09", "1.09 ¿Permite escojer asesor comercial en presupuestos?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 2, "VENPPEPA09", "2.09 ¿Permite escojer asesor comercial en pre-pedidos?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 3, "VENPEDPA09", "3.09 ¿Permite escojer asesor comercial en pedidos?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 4, "VENNOTPA09", "4.09 ¿Permite escojer asesor comercial en notas de entrega?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 5, "VENFACPA09", "5.09 ¿Permite escojer asesor comercial en factura?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 6, "VENNCRPA09", "6.09 ¿Permite escojer asesor comercial en nota de crédito?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 7, "VENNDBPA11", "7.11 ¿Permite escojer asesor comercial en nota de débito?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM32", "0.32 Para hacer recambios de mercancías, la DEVOLUCIÓN es igual a EL RECAMBIO?", TipoParametro.iNoSi, "0") 'ULTIMO
