Module jytsistema
    ...
    Public Const strCon As String = " user id=root; password=jytsuite; Persist Security Info=True;default command timeout=250; " _
                                    & "Connect Timeout=15; pooling=TRUE; Allow Zero Datetime=True "
