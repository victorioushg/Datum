...
Module ConsultasPuntosdeVentas
    ...
    Public Function SeleccionPOSReporteX(ByVal FechaDesde As Date, ByVal FechaHasta As Date, _
                                                  ...
                                                  ByVal CodigoCajeroDesde As String, ByVal CodigoCajeroHasta As String, _
                                                  Optional RetirosYRetenciones As Boolean = False) As String
        ...
        SeleccionPOSReporteX = " SELECT a.caja, a.origen, a.tipomov, a.nummov, (CASE WHEN a.formpag = 'EF' THEN 'EFECTIVO' " _
                ...
                & " ELSE d.nomban " _
                & " END) nompag, " _
                & " IF( a.tipomov in ('EN', 'CR'), a.importe, -1*if(a.nompag = '', a.importe, if(" & RetirosYRetenciones & ", a.importe,0))) importe, " _
                & " a.cantidad, a.cajero " _
                & " FROM jsventrapos a " _
