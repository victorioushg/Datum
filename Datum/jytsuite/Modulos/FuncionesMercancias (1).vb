...
Module FuncionesMercancias
        ...
        If dt.Rows.Count > 0 Then
            For kCont = 0 To dt.Rows.Count - 1
                ...
                With dt.Rows(kCont)
                    ...
                    Else
                        EjecutarSTRSQL(MyConn, lblInfo, " insert into jsmerextalm set codart = '" & UCase(.Item("codart")) & "', almacen = '" & .Item("almacen") & "', existencia = " & .Item("existencia") & " , ubicacion = '', id_emp = '" & jytsistema.WorkID & "'  ")
                    End If
                End With
            Next
        End If
    ...
    Function CantidadVentasEnElMes_KGR(MyConn As MySqlConnection, CodigoAsesor As String, CodigoMercancia As String, _
        ...
        Return CDbl(EjecutarSTRSQL_ScalarPLUS(MyConn, " SELECT SUM( IF( origen = 'NCV', -1,1) * peso) " _
                                                 & " FROM jsmertramer a " _
                                                 & " WHERE " _
