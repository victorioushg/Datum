...
Module ConsultasVentas
    ...
    Function SeleccionVENChequesDevueltos(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        SeleccionVENChequesDevueltos = " select a.numcheque as cheque, a.codcli codigo_cliente, d.nombre, d.alterno, " _
                     ...
                     & "        LEFT JOIN (SELECT a.nummov, SUM(a.importe) pagos, a.id_emp " _
                     & "            		FROM jsventracob a " _
                     & "                    WHERE " _
    ...
    VendedorDesde As String, VendedorHasta As String) As String
        ...
        Dim str As String
        str = " a.emision >= '" & FormatoFechaMySQL(FechaDesde) & "' and a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' and "
    ...
    Function SeleccionVENRuta(CodigoRuta As String, TipoRuta As String) As String
        ...
        Return "select a.codrut, a.nomrut, a.comen, a.codzon, c.descrip zona, a.codven, concat(a.codven, ' ', d.nombres, ' ', d.apellidos) asesor, " _
            ...
            & " left join jsvenrenrut b on (a.CODRUT = b.CODRUT and a.id_emp = b.ID_EMP and b.tipo = '" & TipoRuta & "') " _
