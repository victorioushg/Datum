...
Module FuncionesTransportables
    ...
    End Function
    Public Sub EsperateUnPoquito(ByVal MyConn As MySqlConnection)
    ...
    Function AutoCodigoPlus(MyConn As MySqlConnection, Campo As String, Tabla As String, CampoDocumento As String, Documento As String, longitudMascara As Integer) As String
        Dim strUltimo As Integer = CInt(EjecutarSTRSQL_ScalarPLUS(MyConn, " select " & Campo & " from " & Tabla & " Where  " & CampoDocumento & " = '" & Documento & "' and id_emp = '" & jytsistema.WorkID & "' order by " & Campo & " desc ").ToString)
    ...
    Function AutoCodigo(ByVal sLen As Integer, ByVal myDS As DataSet, _
        ByVal NombreTablaEnDataset As String, ByVal NombreCampoEnBaseDatos As String, Optional ByVal Ultimo As Long = 0) As String
...
calculadoraErr:
    ...
    End Function
    Public Function SeleccionaFecha(ByVal FechaInicial As Date, ByVal ParamArray oObjetos() As Object) As String
    ...
    Public Function CargarTablaSimple(ByVal MyConn As MySqlConnection, ByVal lblInfo As Label, ByVal ds As DataSet, ByVal strSQL As String, ByVal Titulo As String, _
        ...
        If dt.Rows.Count > 0 Then
            ...
            f.Cargar(Titulo, ds, dt, nTable, TipoCargaFormulario.iShowDialog, False)
            ...
            Select Case origenNumeroControl
                ...
                Case TipoOrigenNumControl.iImpresoraFiscal 'DESDE LA IMPRESORA FISCAL (INDIVIDUAL IMPRESORA)
                    ...
                    Select Case nTipoImpreFiscal
                        Case 2, 5, 6
                            NumControlFound = UltimaFCFiscalPP1F3(MyConn, lblInfo) & NumeroSERIALImpresoraFISCAL(MyConn, lblInfo, jytsistema.WorkBox)
                        Case 4
    ...
    Public Function PuertoImpresoraFiscal(ByVal MyConn As MySqlConnection, ByVal lblInfo As Label, ByVal CodigoCaja As String) As Integer

        Dim nn As Object = EjecutarSTRSQL_Scalar(MyConn, lblInfo, " SELECT b.puerto " _
                                                                     & " FROM jsvencatcaj a " _
                                                                     & " LEFT JOIN jsconcatimpfis b ON (a.impre_fiscal = b.codigo AND a.id_emp = b.id_emp ) " _
                                                                     & " WHERE " _
                                                                     & " a.codcaj = '" & CodigoCaja & "' AND " _
                                                                     & " a.id_emp = '" & jytsistema.WorkID & "'")
        IIf(IsDBNull(nn), 1, CInt(Replace(nn, "COM", "")))
    End Function
