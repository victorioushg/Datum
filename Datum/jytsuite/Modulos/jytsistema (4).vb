Module jytsistema
    ...
    Public Const strCon As String = " user id=root; password=jytsuite; Persist Security Info=True;default command timeout=250;Connect Timeout=15; pooling=false; Allow Zero Datetime=True "
    ...
    Public AplicacionTipo As TipoAplicacion = TipoAplicacion.iPlus
    ...
    Public aMenuProcesosNomina() As String = {"RibbonGroup13.Procesos recursos humanos.3.1.1", _
                                              ...
                                              "RibbonButton231.Reprocesar conceptos nómina de trabajadores.3.1.2"}
    ...
    Public aMenuProcesosCompras() As String = {"RibbonGroup17.Procesos compras, gastos y cuentas por pagar.4.1.1", _
                                               ...
                                               "RibbonButton239.Asignar y/o modificar numeros de control compras y gastos.4.2.1"}
    ...
    Public aMenuReportesCompras() As String = {"RibbonGroup18.Reportes compras, gastos y cuentas por pagar.4.1.2", _
                                              ...
                                              "RibbonButton65.Cuentas por pagar.4.2.2", _
    ...
    Public aMenuProcesosMercancias() As String = {"RibbonGroup23.Procesos mercancías.7.1.1", _
                                                  ...
                                                  "RibbonButton206.Construcción de cuotas anuales de mercancías.7.2.1"}
    ...
    Public aMenuReportesMedicionGerencial() As String = {"RibbonTab8.Medidición Gerencial.8.0.0", _
                                              ...
                                              "RibbonButton254.Ventas comprativas mes a mes.8.3.2", _
                                              "RibbonButton255.Ventas mes a mes.8.3.2", _
    ...
    Public aMenuProcesosControl() As String = {"RibbonGroup27.Procesos control de gestión.10.1.1", _
                                               ...
                                               "RibbonButton234.Verificación de consecutivos.10.2.1"}
    ...
    Public aDias() As String = {"Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"}
