...
Module FuncionesControl
    ...
    Public Sub IniciarParametros(ByVal Myconn As MySqlConnection, ByVal lblInfo As Label, Optional Empresa As String = "")
        ...
        If ExisteTabla(Myconn, jytsistema.WorkDataBase, "jsconparametros") Then
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM06", "0.09 Diferencial de peso permitido entre el valor de peso transcrito y el valor de peso calculado (Kgr.)", TipoParametro.iCantidadPeso, "0.000", Empresa)
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM41", "2. RETENCIONES IVA", TipoParametro.iCadena, "", Empresa)
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM42", "2.01 ¿Permite realizar Retenciones de IVA?", TipoParametro.iNoSi, "0", Empresa)
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM43", "2.02 Número de días límite para aceptación de Retenciones IVA", TipoParametro.iEntero, "15", Empresa)

            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM44", "3. RETIROS DE EFECTIVO", TipoParametro.iCadena, "", Empresa)
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM45", "3.01 ¿Permite realizar RETIROS en Puntos de Venta para CONTROL DE EFECTIVO?", TipoParametro.iNoSi, "0", Empresa)
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM46", "3.02 TABLA DENOMINACION DE BILLETES", TipoParametro.iTabla, "BILLETES", Empresa)
