...
Module FuncionesControl
    ...
    Public Sub IniciarParametros(ByVal Myconn As MySqlConnection, ByVal lblInfo As Label)
        If ExisteTabla(Myconn, jytsistema.WorkDataBase, "jsconparametros", lblInfo) Then
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM16", "0.01 Validar CUENTA CONTABLE al incluir Banco ...", TipoParametro.iNoSi, 0)
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM17", "0.02 Validar CUENTA CONTABLE al incluir Caja ...", TipoParametro.iNoSi, 0)
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM01", "0.03 Tipos de documentos para los cuales aplica el Impuesto al Débito Bancario (I.D.B.) ...", TipoParametro.iCadena, ".ND.CH.")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM02", "0.04 Porcentaje del Impuesto al Débito Bancario (I.D.B.) ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM03", "0.05 Monto mínimo de la transacción para la cual aplica el Impuesto al Débito Bancario (I.D.B.) ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM04", "0.06 Descripción o Nombre con el cual se identifica el Impuesto al Débito Bancario (I.D.B.) ...", TipoParametro.iCadena, "IMPUESTO AL DEBITO BANCARIO")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM10", "0.07 Activar IDB automáticamente cuando se realiza la transacción (Proceso = NO) ...", TipoParametro.iNoSi, 0)
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM11", "0.08 Tipos de documentos para los cuales aplica COMISION ALTO VALOR (CAV) ...", TipoParametro.iCadena, ".CH.")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM12", "0.09 Monto comisión alto valor (CAV) ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM13", "0.10 Monto mínimo de la transacción para la cual aplica la CAV ...", TipoParametro.iDoble, "0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM14", "0.11 Descripción o Nombre con el cual se identifica la comisión por alto valor (CAV) ...", TipoParametro.iCadena, "COMISION ALTO VALOR")
            InsertarParametro(Myconn, lblInfo, Gestion.iBancos, 0, "BANPARAM15", "0.12 Activar CAV ...", TipoParametro.iNoSi, 0)
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iCompras, 0, "COMPARAM04", "0.04 ¿Exigir código contable en el proveedor? ...", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iCompras, 0, "COMPARAM05", "0.05 ¿Exigir código contable en ABONOS, CANCELACIONES, ETC.? ...", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iCompras, 2, "COMPACOM04", "2.04 ¿Actualización automática de precios a partir de las ganancias? ...", TipoParametro.iNoSi, "1")
            InsertarParametro(Myconn, lblInfo, Gestion.iCompras, 2, "COMPACOM05", "2.05 ¿Utilizar factor de división para el cálculo de precios automático? ...", TipoParametro.iNoSi, "1")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 0, "VENPARAM38", "0.22 SI Origen del NUMERO DE CONTROL ES CERO (0=registro) Verificar TABLA de Números de Control ...", TipoParametro.iTabla, SystemInformation.ComputerName)
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 5, "VENFACPA23", "5.23 ¿Incluye precio de Venta Justo (guía cliente) en la factura?", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 5, "VENFACPA26", "5.26 FECHA VENCIMIENTO factura calculada con base en días hábiles ", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 5, "VENFACPA27", "5.27 VALIDACION DE CUOTAS FIJAS en la facturación, para cada ASESOR COMERCIAL? ", TipoParametro.iNoSi, "0")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 8, "VENCXCPA03", "8.19 DESCUENTOS Pronto Pago 1 (desde,hasta,porcentaje) ", TipoParametro.iVector, "0,0,0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 8, "VENCXCPA04", "8.20 DESCUENTOS Pronto Pago 2 (desde,hasta,porcentaje) ", TipoParametro.iVector, "0,0,0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 8, "VENCXCPA05", "8.21 DESCUENTOS Pronto Pago 3 (desde,hasta,porcentaje) ", TipoParametro.iVector, "0,0,0.00")
            InsertarParametro(Myconn, lblInfo, Gestion.iVentas, 8, "VENCXCPA06", "8.22 DESCUENTOS Pronto Pago 4 (desde,hasta,porcentaje) ", TipoParametro.iVector, "0,0,0.00")
            ...
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM39", "0. GENERAL", TipoParametro.iCadena, "")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM18", "0.01 Cantidad de meses para vencimientos de apartados", TipoParametro.iEntero, "1")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM20", "0.02 Almacén de movimientos para el punto de venta ...", TipoParametro.iCadena, "00001")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM21", "0.03 ¿Validar existencias de mercancías por almacén? ", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM22", "0.04 Longitud de código de barras de mercancía por peso ", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM23", "0.05 Longitud de código de barras de precio (comienza al final del código de barras de la mercancia por peso)", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM24", "0.06 ¿ACTUALIZAR INVENTARIO una vez cerrada la factura? ", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM25", "0.07 ¿ver FACTURAS EN ESPERA en todas las cajas? ", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM32", "0.08 Para hacer recambios de mercancías, la DEVOLUCIÓN es igual a EL RECAMBIO?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM33", "0.09 ¿VALIDACION DE REGULACION DE VENTAS EN MERCANCIAS?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM34", "0.10 ¿DESEA USAR OFERTA SOBRE LA UNIDAD DE VENTA ADICIONAL DEL NEGOCIO (CAJ)?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM35", "0.11 DEFINA LA TARIFA DE PRECIO A ASIGNAR PARA OFERTA (A B C D E F) ", TipoParametro.iCadena, "D")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM36", "0.12 AL USAR OFERTA SOBRE LA UNIDAD DE VENTA ADICIONAL ¿DESACTIVAR LOS DESCUENTOS POR RENGLON? ", TipoParametro.iNoSi, "1") 'ULTIMO
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM37", "0.13 ¿DESEA USAR MENSAJES EN CINTILLO FACTURA?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM38", "0.14 TABLA DE MENSAJES PARA CINTILLO FACTURA", TipoParametro.iTabla, "MENSAJES")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM40", "0.15 Tiempo de presentación de mensajes en cintillo ", TipoParametro.iEntero, "10")


            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM00", "1. FACTURAS", TipoParametro.iCadena, "")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM01", "1.01 ¿Permite seleccionar clientes?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM02", "1.02 ¿Indicar nombre de cliente obligatoriamente?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM03", "1.03 ¿Indicar número de Registro de Información Fiscal (RIF) obligatoriamente?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM04", "1.04 ¿Indicar número de teléfono del cliente obligatoriamente?...", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM05", "1.05 ¿Permite reimpresión de factura?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM06", "1.06 ¿Permite cheques como forma de pago?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM07", "1.07 ¿Permite tarjetas de crédito/débito como forma de pago?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM08", "1.08 ¿Permite cheques de alimentación como forma de pago?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM09", "1.09 ¿Permite depósitos en bancos como forma de pago?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM10", "1.10 Redondear a cero (0) totales de factura", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM11", "1.11 Tarifa de precios para facturación en puntos de venta...", TipoParametro.iCadena, "A")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM12", "1.12 ¿Permite editar precio en renglones de factura?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM13", "1.13 ¿Imprimir total de factura adicionalmente en moneda alterna?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM14", "1.14 Longitud de código de barras de mercancía", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM15", "1.15 Longitud de código de barras de talla (comienza al final del código de barras)", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM16", "1.16 Longitud de código de barras de color (comienza al final del código de barras de talla)", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM17", "1.17 Formato papel impresora ...", TipoParametro.iFormatoPapel, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM26", "1.18 Modo de impresora...", TipoParametro.iModoImpresora, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM27", "1.19 Número de líneas de factura en impresoras matriciales...", TipoParametro.iEntero, "39")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM28", "1.20 Número máximo de items por factura ... ", TipoParametro.iEntero, "8")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM29", "1.21 Número de líneas para comienzo de factura en papel (margen superior)", TipoParametro.iEntero, "8")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM31", "1.22 Número de líneas para pie de factura en papel (margen inferior)", TipoParametro.iEntero, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM30", "1.23 Número de copias por factura", TipoParametro.iEntero, "1")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM19", "1.24 Tipo impresora fiscal...", TipoParametro.iTipoImpresoraFiscal, "0")

            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM41", "2. RETENCIONES IVA", TipoParametro.iCadena, "")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM42", "2.01 ¿Permite realizar Retenciones de IVA?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM43", "2.02 Número de días límite para aceptación de Retenciones IVA", TipoParametro.iEntero, "15")

            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM44", "3. RETIROS DE EFECTIVO", TipoParametro.iCadena, "")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM45", "3.01 ¿Permite realizar RETIROS en Puntos de Venta para CONTROL DE EFECTIVO?", TipoParametro.iNoSi, "0")
            InsertarParametro(Myconn, lblInfo, Gestion.iPuntosdeVentas, 0, "POSPARAM46", "3.02 TABLA DENOMINACION DE BILLETES", TipoParametro.iTabla, "BILLETES")
    ...
    End Sub
    Public Function ContadorNC_Financiera(ByVal myconn As MySqlConnection, ByVal lblInfo As Label, ByVal CodigoCausaNC As String, _
                             ByVal OrigenCausaNC As String, Optional ByVal Incrementar As Boolean = True) As String

        ContadorNC_Financiera = EjecutarSTRSQL_ScalarPLUS(myconn, " SELECT NUMPAG FROM jsconcausas_notascredito WHERE CODIGO = '" & CodigoCausaNC & "' AND ORIGEN = '" & OrigenCausaNC & "' ").ToString

        If Incrementar Then
            Dim newContador As String = IncrementarCadena(ContadorNC_Financiera)
            EjecutarSTRSQL(myconn, lblInfo, " UPDATE jsconcausas_notascredito SET NUMPAG = '" & newContador & "' WHERE CODIGO = '" & CodigoCausaNC & "' AND ORIGEN = '" & OrigenCausaNC & "' ")
        End If
