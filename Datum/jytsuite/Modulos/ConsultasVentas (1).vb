...
Module ConsultasVentas
    ...
    Function SeleccionVENListadoPedidos(ByVal NumeroPedidoDesde As String, ByVal NumeroPedidoHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        & " a.tot_net, a.descuen, a.cargos, a.imp_iva, a.tot_ped tot_fac, 0.00 SaldoFactura, elt(tipocredito+1,'CR','CO') tipocredito, a.entrega vence " _
    ...
    Function SeleccionVENListadoNotasDeEntrega(ByVal NumeroPedidoDesde As String, ByVal NumeroPedidoHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        & " left join jsconcatter o on (c.fciudad = o.codigo and c.id_emp = o.id_emp) " _
        & " left join jsconcatter p on (c.fbarrio = p.codigo and c.id_emp = p.id_emp) " _
        & " LEFT JOIN ( SELECT a.codcli, a.nummov, SUM(a.importe) saldo, a.id_emp " _
        & "                 FROM jsventracob a " _
        & "                 WHERE " _
        & "                 a.id_emp = '" & jytsistema.WorkID & "' " _
    ...
    Public Function SeleccionVENSaldoClientes(ByVal MyConn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        EjecutarSTRSQL(MyConn, lblInfo, " create temporary table " & TablaSaldos & " select a.codcli, sum(a.importe) saldo " _
            & " from jsventracob a " _
            & " where " _
        ...
        SeleccionVENSaldoClientes = " select a.codcli, a.nombre, a.alterno, a.ingreso, a.rif, f.descrip canal, " _
            & " g.descrip tiponegocio, h.descrip zona, i.nomrut ruta, " _
            & " k.nombre pais, l.nombre estado, m.nombre municipio, n.nombre parroquia, o.nombre ciudad, p.nombre barrio, " _
            & " concat(c.codven,' ',c.apellidos,', ',c.nombres) asesor, if( b.saldo is null, 0.00, b.saldo) saldo " _
            & " from jsvencatcli a " _
            & " left join " & TablaSaldos & " b on ( a.codcli = b.codcli ) " _
            ...
            & " left join jsvenlistip g on (a.unidad = g.codigo and a.categoria = g.antec and a.id_emp = g.id_emp ) " _
            ...
            & " left join jsconcatter k on (a.fpais = k.codigo and a.id_emp = k.id_emp) " _
            & " left join jsconcatter l on (a.festado = l.codigo and a.id_emp = l.id_emp) " _
            & " left join jsconcatter m on (a.fmunicipio = m.codigo and a.id_emp = m.id_emp) " _
            & " left join jsconcatter n on (a.fparroquia = n.codigo and a.id_emp = n.id_emp) " _
            & " left join jsconcatter o on (a.fciudad = o.codigo and a.id_emp = o.id_emp) " _
            & " left join jsconcatter p on (a.fbarrio = p.codigo and a.id_emp = p.id_emp) " _
            & " Where " _
            & " b.saldo <> 0.00 and " _
            & str _
            & " a.id_emp ='" & jytsistema.WorkID & "' " _
    ...
    Function SeleccionVENPrePedidos(ByVal NumeroPrepedidoDesde As String, ByVal NumeroPrepedidoHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        SeleccionVENPrePedidos = " select a.numped, a.emision, a.entrega, a.vence, a.codcli, b.item, b.item item_codart, b.renglon, b.descrip, b.cantidad, b.unidad, " _
        & " concat(c.nombre,a.comen) nombre, c.rif, " _
        & " f.descrip canal, g.descrip tiponegocio, h.descrip zona, i.nomrut ruta, a.codven, concat(a.codven,' ', j.nombres, ' ', j.apellidos) asesor, " _
        & " k.nombre pais, l.nombre estado, m.nombre municipio, n.nombre parroquia, o.nombre ciudad, p.nombre barrio, " _
    ...
    Public Function SeleccionVENEstadoDeCuentaClientesPlus(ByVal ProveedorDesde As String, ByVal ProveedorHasta As String, ByVal OrdenadoPor As String, ByVal operador As Integer, _
        ...
        Return " SELECT a.codcli, a.nombre, a.alterno, a.ingreso, a.rif, e.nummov, e.tipomov, e.emision, e.hora, e.vence, e.refer, e.concepto, " _
            ...
            & " FROM jsvencatcli a " _
            & " LEFT JOIN (SELECT a.codcli, SUM(a.importe) saldo FROM jsventracob a WHERE a.emision < '" & FormatoFechaMySQL(FEchaDesde) & "' AND a.id_emp = '" & jytsistema.WorkID & "' GROUP BY a.codcli ) b ON ( a.codcli = b.codcli ) " _
    ...
    Public Function SeleccionVENEstadoDeCuentaClientes(ByVal ProveedorDesde As String, ByVal ProveedorHasta As String, ByVal OrdenadoPor As String, ByVal operador As Integer, _
        ...
        SeleccionVENEstadoDeCuentaClientes = " select a.codcli, a.nombre, a.alterno, a.ingreso, a.rif, " _
            ...
            & " if( b.saldo is null, 0.00, b.saldo) saldo " _
            & " from jsvencatcli a " _
            & " left join (select a.codcli, sum(a.importe) saldo " _
            & "             from jsventracob a " _
            & "             where " _
    ...
    Public Function SeleccionVENMovimientosDocumentos(ByVal DocumentoDesde As String, ByVal DocumentoHasta As String, ByVal OrdenadoPor As String, ByVal operador As Integer, _
                                          FechaDesde As Date, ByVal FechaHasta As Date) As String

        Dim str As String = ""

        If DocumentoDesde <> "" Then str += " a.nummov >= '" & DocumentoDesde & "' and "
        If DocumentoHasta <> "" Then str += " a.nummov <= '" & DocumentoHasta & "' and "
    ...
    Function SeleccionVENAuditoriaClientes(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        SeleccionVENAuditoriaClientes = " select a.codcli, c.alterno, c.nombre,  c.rif, a.nummov, a.importe, a.saldo, " _
                ...
                & "         from jsventracob a " _
                & "         left join ( select a.codcli, a.nummov, sum(a.importe) saldo " _
                & "                     from jsventracob a " _
                & "                     Where " _
                & "                     a.fechasi <= '" & FormatoFechaMySQL(FechaHasta) & "' and " _
                ...
                & " where " _
                & str _
                & " b.fechasi <= '" & FormatoFechaMySQL(FechaHasta) & "' and " _
    ...
    Function SeleccionVENVencimientosPlus(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        SeleccionVENVencimientosPlus = "SELECT a.codcli, b.nombre, a.nummov, a.tipomov, a.refer, a.EMISION, a.VENCE, a.importe, a.saldo, a.lapso, a.de, a.dv, a.id_emp " _
            ...
            & "          FROM (SELECT a.codcli, a.nummov, a.tipomov, a.refer, MIN(a.emision) emision, MIN(a.vence) vence, a.importe,  SUM(a.importe) saldo,  " _
            & " (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - TO_DAYS(MIN(a.vence))) AS DV, " _
            & " (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - TO_DAYS(MIN(a.emision))) AS DE, a.id_emp " _
            & " FROM jsventracob a " _
            & " WHERE " _
            & " a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
            & " a.id_emp = '" & jytsistema.WorkID & "' " _
    ...
    Function SeleccionVENVencimientosResumen(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        & " from jsvencatcli a " _
        & " left join ( SELECT a.CODCLI, a.NUMMOV, SUM(a.importe) AS SALDO, " _
        ...
        & "             if( (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) >= " & Lapso1Desde & " and (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) <= " & lapso1Hasta & ", '1' , " _
        & "             if( (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) >= " & Lapso2Desde & " and (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) <= " & lapso2Hasta & ", '2' , " _
        & "             if( (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) >= " & Lapso3Desde & " and (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) <= " & lapso3Hasta & ", '3' , " _
        & "             if( (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - to_Days(a.emision)) >= " & Lapso4Desde & ", '4' , '0' " _
    ...
    Function SeleccionVENVencimientosResumenPlus(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        & "                     FROM (SELECT a.codcli, a.nummov, MIN(a.emision), SUM(a.importe) saldo, " _
        & "                     	    (TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - TO_DAYS(MIN(a.vence))) AS DV, " _
        & "                         	(TO_DAYS('" & FormatoFechaMySQL(FechaHasta) & "') - TO_DAYS(MIN(a.emision))) AS DE " _
        & "                         	FROM jsventracob a " _
        & "                             WHERE " _
        & " 	                        a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
        & "                         	a.id_emp = '" & jytsistema.WorkID & "' " _
    ...
    Function SeleccionVENActivacionesClientesYMercancias(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        & "             Where " _
        & strX _
        & "             a.fechamov > '" & FormatoFechaMySQL(DateAdd("d", -1, FechaInicio)) & "' and " _
        & "             a.fechamov < '" & FormatoFechaMySQL(DateAdd("d", 1, FechaFin)) & "' and " _
        ...
        & "                             Where " _
        & strX _
        & "                             a.fechamov > '" & FormatoFechaMySQL(DateAdd("d", -1, CDate("01/01/" & Year(FechaInicio)))) & "' and " _
        & "                             a.fechamov < '" & FormatoFechaMySQL(FechaInicio) & "' and " _
        & "                             a.origen in('FAC','PFC','PVE','NCV','NDV') and " _
        & "                             a.id_emp = '" & jytsistema.WorkID & "' " _
    ...
    Function SeleccionVENLibroIVA(MyConn As MySqlConnection, lblInfo As Label, _
        ...
        Dim aFld() As String = {"numfac.cadena30", "num_control.cadena30", _
            "emision.fecha", "nompro.cadena250", "tipo.cadena5", "rif.cadena20", "fac_afectada.cadena20", _
            "num_nc.cadena20", "controladorregistro.cadena150", "tipotransaccion.cadena2", "tipoiva.cadena", _
            "tot_fac.doble19", "nogravado.doble19", "baseiva.doble19", "poriva.doble6", "impiva.doble19", _
            "baseivanc.doble19", "porivanc.doble6", "impivanc.doble19", "retencion.doble19", "num_retencion.cadena20", _
            "fec_retencion.fecha"}

        EjecutarSTRSQL(MyConn, lblInfo, " drop  temporary table if exists " & tbl)
        ...
        EjecutarSTRSQL(MyConn, lblInfo, " insert into  " & tbl _
            ...
            & "             Where " _
            & "             SUBSTRING(a.numfac ,1,2 ) = 'NC' AND a.emision >= '" & FormatoFechaMySQL(FechaDesde) & "' AND a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
            ...
            & " Where " _
            & "  NOT c.poriva IS NULL AND SUBSTRING(a.numfac,1,2) = 'NC' AND a.emision >= '" & FormatoFechaMySQL(FechaDesde) & "'  AND a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
    ...
    Function SeleccionVENActivacionesClientes(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        SeleccionVENActivacionesClientes = "Select a.codcli, " _
                        ...
                        & " left join (select prov_cli codcli, count(*) chdaño from jsbanchedev where year(fechadev) = '" & Year(FechaDesde) & "' and id_emp = '" & jytsistema.WorkID & "' group by 1) d on (a.codcli = d.codcli) " _
    ...
    Function SeleccionVENActivacionesClientesMES(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
        ...
        SeleccionVENActivacionesClientesMES = "Select a.codcli, " _
                        ...
                        & "                 from jsvenencfac a " _
                        & "                 Where " _
                        & "                 a.emision >= '" & FormatoFechaMySQL(DateAdd(DateInterval.Year, -1, FechaDesde)) & "' and " _
                        & "                 a.emision <= '" & FormatoFechaMySQL(DateAdd(DateInterval.Year, -1, FechaHasta)) & "' and " _
                        & "                 a.id_emp = '" & jytsistema.WorkID & "' " _
                        & "                 group by a.codcli ) c on (a.codcli = c.codcli) " _
                        & " left join jsvenliscan f on (a.categoria = f.codigo and a.id_emp = f.id_emp ) " _
                        & " left join jsvenlistip g on (a.unidad = g.codigo and a.id_emp = g.id_emp ) " _
    ...
    Function SeleccionVENChequesDevueltos(ByVal ClienteDesde As String, ByVal ClienteHasta As String, ByVal OrdenadoPor As String, ByVal Operador As Integer, _
                                      Optional ByVal CanalDesde As String = "", Optional ByVal CanalHasta As String = "", _
                                      Optional ByVal TipoDesde As String = "", Optional ByVal TipoHasta As String = "", _
                                      Optional ByVal ZonaDesde As String = "", Optional ByVal ZonaHasta As String = "", _
                                      Optional ByVal RutaDesde As String = "", Optional ByVal RutaHasta As String = "", _
        ...
        Dim str As String = CadenaComplementoClientes("d", ClienteDesde, ClienteHasta, Operador, OrdenadoPor, _
                                                      CanalDesde, CanalHasta, TipoDesde, TipoHasta, ZonaDesde, _
                                                      ZonaHasta, RutaDesde, RutaHasta, Pais, Estado, Municipio, Parroquia, Ciudad, Barrio, TipoCliente, EstatusCliente)
        ...
        SeleccionVENChequesDevueltos = " select a.numcheque as cheque, a.codcli codigo_cliente, d.nombre, d.alterno, " _
                     ...
                     & " from ( SELECT a.id_emp, a.prov_cli codcli, a.numcheque, b.nummov, b.importe, a.fechadev, SUM(IF(c.nummov IS NULL,0,c.importe)) pagos, " _
                     & "        b.importe + SUM(IF(c.nummov IS NULL,0,c.importe)) saldo, b.codven, TO_DAYS(CURRENT_DATE)-TO_DAYS(a.fechadev) dias_mora " _
                     & "        FROM jsbanchedev a " _
                     & "        LEFT JOIN jsventracob b ON (a.numcheque=b.numorg AND a.id_emp=b.id_emp) " _
                     & "        LEFT JOIN jsventracob c ON (c.numorg <> a.numcheque AND b.id_emp=c.id_emp AND b.nummov=c.nummov ) " _
                     & "        WHERE " _
                     & "        a.id_emp = '" & jytsistema.WorkID & "' " _
                     ...
                     & "                    a.fechadev fecha, SUM(IF(c.nummov IS NULL,0,c.importe)) pagos, " _
                     & "        	        b.importe + SUM(IF(c.nummov IS NULL,0,c.importe)) saldo, " _
    ...
    Function SeleccionVENCierreFinancieroContado(ByVal EmisionDesde As Date, ByVal EmisionHasta As Date, ByVal AsesorDesde As String, ByVal AsesorHasta As String) As String
        ...
        SeleccionVENCierreFinancieroContado = "  select a.codven vendedor, a.codcli, b.nombre, 'CA' tipomov, " _
                    ...
                    & " if( c.vence > '" & FormatoFechaMySQL(EmisionHasta) & "','SI','') diferido, " _
                    & " c.origen " _
                    & " from jsvenencfac a " _
                    & " left join jsvencatcli b on (a.codcli = b.codcli and a.id_emp = b.id_emp)" _
                    ...
                    & " where " _
                    & str _
                    & " a.emision >= '" & FormatoFechaMySQL(EmisionDesde) & "' and " _
                    & " a.emision <= '" & FormatoFechaMySQL(EmisionHasta) & "' and " _
                    & " a.condpag = 1 AND " _
                    & " a.ejercicio = '" & jytsistema.WorkExercise & "' and " _
                    & " a.id_emp = '" & jytsistema.WorkID & "' " _
                    & " order by a.numfac "
    ...
    Function SeleccionVENCierreFinanciero(EmisionDesde As Date, EmisionHasta As Date, AsesorDesde As String, AsesorHasta As String) As String
        ...
        SeleccionVENCierreFinanciero = "select b.vendedor, a.codcli, b.nombre ,a.tipomov, " _
                        ...
                        & " a.fotipo, if(a.emision > '" & FormatoFechaMySQL(EmisionHasta) & "','SI','') diferido " _
                        & " from jsventracob a " _
                        & " LEFT JOIN jsvencatcli b ON (a.codcli = b.codcli and a.id_emp = b.id_emp) " _
                        & " left join jsconctatar d on (a.nompag = d.codtar and a.id_emp = d.id_emp) " _
                        & " WHERE " _
                        & str _
                        & " a.fechasi >= '" & FormatoFechaMySQL(EmisionDesde) & "' and " _
                        & " a.fechasi <= '" & FormatoFechaMySQL(EmisionHasta) & "' and " _
                        & " a.id_emp = '" & jytsistema.WorkID & "' and " _
                        & " a.ejercicio = '" & jytsistema.WorkExercise & "' and " _
    ...
    Function SeleccionVENMercanciasGuiaPedidos(ByVal PedidoInicial As String, ByVal PedidoFinal As String, _
        ...
        Return " SELECT 'REL' codigoguia, 'RELACION DE CARGA' descripcion, '" & FormatoFechaMySQL(jytsistema.sFechadeTrabajo) & "' fechaguia, " _
            & " '" & FormatoFechaMySQL(FechaInicial) & "'  emisionfac, '" & FormatoFechaMySQL(FechaFinal) _
            ...
            & str _
            & " b.estatus = 0 and " _
            & " b.emision >= '" & FormatoFechaMySQL(FechaInicial) & "' AND " _
            & " b.emision <= '" & FormatoFechaMySQL(FechaFinal) & "' AND " _
            & " a.id_emp = '" & jytsistema.WorkID & "' " _
    ...
    Function SeleccionVENPedidosSinFacturar(EmisionDesde As Date, EmisionHasta As Date, _
        ...
        SeleccionVENPedidosSinFacturar = "select a.item , b.nomart, b.unidad, " _
            ...
            & " and (e.emision between '" & FormatoFechaMySQL(EmisionDesde) & "' and '" & FormatoFechaMySQL(EmisionHasta) & "') " _
    ...
    Function SeleccionVENVentasClientesAct(ClienteDesde As String, ClienteHasta As String, OrdenadoPor As String, _
        ...
        strsqlEmision += " a.fechamov >= '" & FormatoFechaHoraMySQLInicial(EmisionDesde) & "' and "
        strsqlEmision += " a.fechamov <= '" & FormatoFechaHoraMySQLFinal(EmisionHasta) & "' and "
        ...
        Dim str As String = " select elt(b.mix+1,'ECONOMICO','ESTANDAR','SUPERIOR') AS mix, " _
            ...
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV'),  a.peso, 0)) as pesoventas, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV'),  if( isnull(m.uvalencia), a.cantidad, a.cantidad/m.equivale), 0)) as cantidadventas, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV'),  a.costotaldes, 0)) as costoventas, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV'),  a.ventotaldes, 0)) as ventasventas, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen <> '00002',  a.peso, 0)) pesodbe, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen <> '00002',  if( isnull(m.uvalencia), a.cantidad, a.cantidad/m.equivale), 0)) cantidaddbe, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen <> '00002',  a.costotaldes, 0)) costodbe, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen <> '00002',  a.ventotaldes, 0)) ventasdbe, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen = '00002',  a.peso, 0)) pesodme, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen = '00002',  if( isnull(m.uvalencia), a.cantidad, a.cantidad/m.equivale), 0)) cantidaddme, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen = '00002',  a.costotaldes, 0)) costodme, " _
            & " sum(if( a.origen not in('FAC','PFC','PVE','NDV') and a.almacen = '00002',  a.ventotaldes, 0)) ventasdme, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV') ,  a.peso, -1*a.peso)) pesoneto, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV') ,  if( isnull(m.uvalencia), a.cantidad, a.cantidad/m.equivale),-1*if( isnull(m.uvalencia), a.cantidad, a.cantidad/m.equivale))) cantidadneta, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV') ,  a.costotaldes, -1*costotaldes)) costoneto, " _
            & " sum(if( a.origen in('FAC','PFC','PVE','NDV') ,  a.ventotaldes, -1*ventotaldes)) ventasnetas, " _
            & " 'A' peso, " _
    ...
    Function SeleccionVENVentasPorDivision(EmisionDesde As Date, EmisionHasta As Date, ClienteDesde As String, ClienteHasta As String, _
                                           CanalDesde As String, CanalHasta As String, _
                                           TiponegocioDesde As String, TipoNegocioHasta As String,
                                           ZonaDesde As String, ZonaHasta As String, _
                                           RutaDesde As String, RutaHasta As String, _
                                           AsesorDesde As String, AsesorHasta As String, _
                                           Pais As String, Estado As String, Municipio As String, _
                                           Parroquia As String, Ciudad As String, Barrio As String, _
                                           Estatus As Integer) As String

        Dim strClientes As String

        strClientes = CadenaComplementoClientes("c", ClienteDesde, ClienteHasta, 0, "", CanalDesde, CanalHasta, TiponegocioDesde, TipoNegocioHasta, _
            ZonaDesde, ZonaHasta, RutaDesde, RutaHasta, Pais, Estado, Municipio, Parroquia, Ciudad, Barrio, , Estatus)

        If AsesorDesde <> "" Then strClientes += " a.vendedor >= '" & AsesorDesde & "' and "
        If AsesorHasta <> "" Then strClientes += " a.vendedor <= '" & AsesorHasta & "' and "

        SeleccionVENVentasPorDivision = " select a.prov_cli, c.nombre, " _
            & " a.vendedor, " _
            & " g.descrip as canal, if(h.descrip is null, '', h.descrip) tiponegocio, " _
            & " if( i.descrip is null, '', i.descrip) zona, if( j.nomrut is null, '', j.nomrut) ruta, " _
            & " concat(k.codven,' ', k.apellidos, ', ', k.nombres) as asesor, " _
            ...
            & " if( r.nombre is null, '', r.nombre) estado, " _
            & " if( s.nombre is null, '', s.nombre) pais, " _
            & " sum(if(b.division = '00001', a.peso, 0)) div01, " _
            & " sum(if(b.division = '00002', a.peso, 0)) div02, " _
            & " sum(if(b.division = '00003', a.peso, 0)) div03, " _
            & " sum(if(b.division = '00004', a.peso, 0)) div04, " _
            & " sum(if(b.division = '00005', a.peso, 0)) div05, " _
            & " sum(if(b.division = '00006', a.peso, 0)) div06, " _
            & " sum(if(b.division = '00007', a.peso, 0)) div07, " _
            & " sum(if(b.division = '00001', a.peso, 0)) + sum(if(b.division = '00002', a.peso, 0)) + sum(if(b.division = '00003', a.peso, 0)) + sum(if(b.division = '00004', a.peso, 0)) + sum(if(b.division = '00005', a.peso, 0)) +  sum(if(b.division = '00006', a.peso, 0)) + sum(if(b.division = '00007', a.peso, 0)) divtot " _
            & " from jsmertramer a " _
            & " inner join jsmerctainv b on (a.codart = b.codart and a.id_emp = b.id_emp) " _
            & " inner join jsvencatcli c on (a.prov_cli = c.codcli and a.id_emp = c.id_emp) " _
            ...
            & " Where " _
            & " a.fechamov >= '" & FormatoFechaHoraMySQLInicial(EmisionDesde) & "' and " _
            & " a.fechamov <= '" & FormatoFechaHoraMySQLFinal(EmisionHasta) & "' and " _
    ...
    Function SeleccionVENVentasClientesMes(ClienteDesde As String, ClienteHasta As String, _
            Optional CanalDesde As String = "", Optional CanalHasta As String = "", _
            Optional TiponegocioDesde As String = "", Optional TipoNegocioHasta As String = "", _
            Optional ZonaDesde As String = "", Optional ZonaHasta As String = "", _
            Optional RutaDesde As String = "", Optional RutaHasta As String = "", _
            Optional AsesorDesde As String = "", Optional AsesorHasta As String = "", _
            Optional Pais As String = "", Optional Estado As String = "", Optional Municipio As String = "", _
            Optional Parroquia As String = "", Optional Ciudad As String = "", Optional Barrio As String = "") As String

        Dim strSQL As String

        strSQL = CadenaComplementoClientes("b", ClienteDesde, ClienteHasta, 0, "", CanalDesde, CanalHasta, TiponegocioDesde, TipoNegocioHasta, _
        ...
        SeleccionVENVentasClientesMes = " select a.prov_cli, b.nombre, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 1,  a.peso,0) , if(month(a.fechamov) = 1, -1*a.peso,0))) pEne, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 2,  a.peso,0) , if(month(a.fechamov) = 2, -1*a.peso,0))) pFeb, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 3,  a.peso,0) , if(month(a.fechamov) = 3, -1*a.peso,0))) pMar, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 4,  a.peso,0) , if(month(a.fechamov) = 4, -1*a.peso,0))) pAbr, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 5,  a.peso,0) , if(month(a.fechamov) = 5, -1*a.peso,0))) pMay, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 6,  a.peso,0) , if(month(a.fechamov) = 6, -1*a.peso,0))) pJun, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 7,  a.peso,0) , if(month(a.fechamov) = 7, -1*a.peso,0))) pJul, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 8,  a.peso,0) , if(month(a.fechamov) = 8, -1*a.peso,0))) pAgo, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 9,  a.peso,0) , if(month(a.fechamov) = 9, -1*a.peso,0))) pSep, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 10,  a.peso,0) , if(month(a.fechamov) = 10, -1*a.peso,0))) pOct, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 11,  a.peso,0) , if(month(a.fechamov) = 11, -1*a.peso,0))) pNov, " _
            & " sum(if(a.tipomov = 'SA', if( month(a.fechamov) = 12,  a.peso,0) , if(month(a.fechamov) = 12, -1*a.peso,0))) pDic " _
            & " from jsmertramer a " _
            & " left join jsvencatcli b on (a.prov_cli = b.codcli and a.id_emp = b.id_emp) " _
            & " Where " _
            & " a.prov_cli <> '' and " _
            & " a.origen in ('FAC', 'PFC','NDV','NCV','PVE') and " _
            & " a.fechamov >= '" & FormatoFechaHoraMySQLInicial(PrimerDiaAño(jytsistema.sFechadeTrabajo)) & "' and " _
            & " a.fechamov <= '" & FormatoFechaHoraMySQLFinal(UltimoDiaAño(jytsistema.sFechadeTrabajo)) & "' and " _
            & strSQL _
            & " a.id_emp = '" & jytsistema.WorkID & "' " _
            & " Group By " _
            & " Prov_Cli "
    ...
    Function SeleccionVENRankingDeVentas(ByVal MyConn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        If Primeros > 0 Then strSQLPrimeros = " limit " & FormatoEntero(Primeros)
    ...
    Function SeleccionVENSEMAFORO(ByVal AsesorDesde As String, ByVal AsesorHasta As String, _
        ...
        Return " SELECT IF( aa.estatus = 1 , 'ROJO', " _
            & " IF( aa.suma_pedidos > aa.disponible , 'AMARILLO',  " _
            & " IF( aa.comision > 0.00, 'AMARILLO', 'VERDE'))) COLOR, aa.cliente,  " _
            & " 			aa.numero_pedido, aa.monto_pedido, aa.suma_pedidos, aa.disponible, aa.comision, " _
            ...
            & "                     FROM jsconctaiva " _
            & "                     WHERE " _
            & "                     fecha IN (SELECT MAX(fecha) FROM jsconctaiva WHERE fecha <= '" & FormatoFechaMySQL(FechaHasta) & "' GROUP BY tipo) AND " _
            & "                                 fecha <= '" & FormatoFechaMySQL(FechaHasta) & "')  d ON (b.iva = d.tipo) " _
            & "         WHERE " _
            & strAsesor _
            & " 		a.emision >= '" & FormatoFechaMySQL(FechaDesde) & "' AND " _
            & " 		a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
    ...
    Function SeleccionVENPedidosVsEstatusClientes(ByVal myConn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        Dim aFld() As String = {"tipo.cadena", "fecha.fecha"}
        Dim tblUltimoIVA As String = "tbl" & NumeroAleatorio(100000)

        CrearTabla(myConn, lblInfo, jytsistema.WorkDataBase, True, tblUltimoIVA, aFld)
        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblUltimoIVA & " " _
            & " select tipo, max(fecha) from jsconctaiva " _
            & " where fecha<= '" & FormatoFechaMySQL(jytsistema.sFechadeTrabajo) & "'" _
            & " group by 1 ")

        Dim aFld1() As String = {"tipo.cadena", "poriva.doble6"}
        Dim tblIVA As String = "tbl" & NumeroAleatorio(1000000)
        CrearTabla(myConn, lblInfo, jytsistema.WorkDataBase, True, tblIVA, aFld1)
        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblIVA & " " _
        ...
        Dim aFld2() As String = {"pedido.cadena15", "cliente.cadena15", "total_ped.doble19", "vendedor.cadena5"}
        Dim tblPedidosPendientes As String = "tbl" & NumeroAleatorio(1000000)
        CrearTabla(myConn, lblInfo, jytsistema.WorkDataBase, True, tblPedidosPendientes, aFld2, " pedido ")
        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblPedidosPendientes & " " _
            ...
            & " and a.estatus='0' " _
            & " and a.emision>='" & FormatoFechaMySQL(FechaDesde) & "' " _
            & " and a.emision<='" & FormatoFechaMySQL(FechaHasta) & "' " _
        ...
        Dim aFld3() As String = {"cliente.cadena15"}
        Dim tblClientesDistintos As String = "tbl" & NumeroAleatorio(1000000)
        CrearTabla(myConn, lblInfo, jytsistema.WorkDataBase, True, tblClientesDistintos, aFld3)
        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblClientesDistintos & " select distinct cliente from " & tblPedidosPendientes & " ")

        Dim aFld4() As String = {"cliente.cadena15", "nummov.cadena15"}
        Dim tblComisiones As String = "tbl" & NumeroAleatorio(1000000)
        CrearTabla(myConn, lblInfo, jytsistema.WorkDataBase, True, tblComisiones, aFld4)
        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblComisiones & " " _
        ...
        Dim tblClientesComisionesCheques As String = "tbl" & NumeroAleatorio(100000)
        EjecutarSTRSQL(myConn, lblInfo, "create temporary table " & tblClientesComisionesCheques & " (cliente char(15), total_com double(19,2))")
        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblClientesComisionesCheques & " " _
        ...
        Dim tblSemaforo As String = "tbl" & NumeroAleatorio(100000)
        EjecutarSTRSQL(myConn, lblInfo, "create temporary table " & tblSemaforo & " (color char(15), cliente char(15),total_pedidos double (19,2), " _
        & " disponible double (19,2), comision double(19,2),nombre_cliente VARchar(150)) ")

        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblSemaforo & " " _
        ...
        Dim tblUltimoBloqueo As String = "tbl" & NumeroAleatorio(1000000)
        EjecutarSTRSQL(myConn, lblInfo, "create temporary table " & tblUltimoBloqueo & " (cliente char(15), fecha date) ")

        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblUltimoBloqueo & " " _
        ...
        Dim tblUltimaTabla As String = "tbl" & NumeroAleatorio(1000000)
        EjecutarSTRSQL(myConn, lblInfo, "create temporary table " & tblUltimaTabla & " (color char(15), cliente char(15), numero_pedido Char(15), " _
        ...
        Select Case Condicion
            Case 0
                EjecutarSTRSQL(myConn, lblInfo, strRojo)
            Case 1
                EjecutarSTRSQL(myConn, lblInfo, strAmarillo)
            Case 2
                EjecutarSTRSQL(myConn, lblInfo, strVerde)
            Case 3
                EjecutarSTRSQL(myConn, lblInfo, strAmarillo)
                EjecutarSTRSQL(myConn, lblInfo, strRojo)
            Case 4
    ...
    ByVal Fecha As Date) As String
        ...
        tblTemp = "tbl" & Format(NumeroAleatorio(10000), "00000")

        EjecutarSTRSQL(myConn, lblInfo, "create temporary table " & tblTemp & "(" _
        ...
        EjecutarSTRSQL(myConn, lblInfo, " INSERT INTO " & tblTemp & " select b.vendedor, " _
            & " a.comproba, a.fechasi, sum(a.importe) " _
            & " from jsventracob a, jsvencatcli b " _
            & " Where " _
            & " a.codcli = b.codcli and " _
            & " a.id_emp = b.id_emp and " _
            & str _
            & " a.fechasi = '" & FormatoFechaMySQL(Fecha) & "' and " _
            & " a.id_emp = '" & jytsistema.WorkID & "' and " _
            & " a.ejercicio = '" & jytsistema.WorkExercise & "' and " _
        ...
        SeleccionVENCierreCestaTicket = "select a.vendedor, c.numcan, d.descrip corredor, " _
            & " c.monto monto, count(*) as cantidad, sum(c.monto) montotal, " _
    ...
    Function SeleccionVENCobranzaPlana(ByVal Myconn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        Return " SELECT a.vendedor, CONCAT(b.apellidos, ' ', b.nombres) nomAsesor, a.codcli, a.nombre, c.descrip TipoNegocio, " _
            ...
            & " LEFT JOIN (SELECT a.codcli, a.nummov, SUM(a.importe) importe, a.id_emp " _
            & " 	        FROM jsventracob a " _
            & "             WHERE  " _
            & "	            a.tipomov = 'NC' AND " _
            & "	            a.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
            ...
            & " WHERE " _
            & " d.emision >= '" & FormatoFechaMySQL(FechaDesde) & "' AND " _
            & " d.emision <= '" & FormatoFechaMySQL(FechaHasta) & "' AND " _
            & strX _
            & " a.id_emp = '" & jytsistema.WorkID & "' " _
            & " UNION " _
    ...
    Function SeleccionVENCuotasCobranza(ByVal myConn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        Dim nTablaSaldos As String
        Dim nTablaPagos As String
        Dim nTablaTotalSaldos As String
        Dim nTablaDocumentosAnteriores As String, Tabla1 As String, Tabla2 As String
        Dim nIndiceDocumentosAnteriores As String, nIndiceSaldos As String, nIndicePagos As String
        Dim nIndiceTotalSaldos As String

        Dim strVen As String = ""
        Dim strVen1 As String = ""


        Dim nMes As Integer, strMes As String
        Dim DaysToend As Integer
      
        nMes = Month(FechaActual)
        strMes = Format(nMes, "00")
        ...
        nTablaSaldos = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nTablaPagos = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nTablaTotalSaldos = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nTablaDocumentosAnteriores = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nIndiceSaldos = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nIndicePagos = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nIndiceTotalSaldos = "tbl" & Format(NumeroAleatorio(10000), "00000")
        nIndiceDocumentosAnteriores = "tbl" & Format(NumeroAleatorio(10000), "00000")

        DaysToend = DiasHabilesRestantesDelMes(myConn, lblInfo, FechaActual)
        If nMes < Month(jytsistema.sFechadeTrabajo) And DaysToend = 1 Then DaysToend = 0

        If TipoSeleccion = 0 Then

            EjecutarSTRSQL(myConn, lblInfo, " create temporary table " & nTablaSaldos & " ( codcli varchar(15) not null, saldo double(19,2) default '0.00' not null) ")
            EjecutarSTRSQL(myConn, lblInfo, " create index " & nIndiceSaldos & " on " & nTablaSaldos & " (codcli) ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & nTablaSaldos _
                & " select a.codcli, round(sum(b.importe),2) as saldo " _
                & " from jsvencatcli a " _
                & " left join jsventracob b on (a.codcli = b.codcli and a.id_emp = b.id_emp) " _
                & " Where " _
                & " b.emision < '" & FormatoFechaMySQL(PrimerDiaMes(FechaActual)) & "' and " _
                & " a.id_emp = '" & jytsistema.WorkID & "' " _
                & " group by a.codcli " _
                & " having  saldo > 0.0001 or saldo < -0.0001 ")

            EjecutarSTRSQL(myConn, lblInfo, " create temporary table " & nTablaDocumentosAnteriores & " (codcli varchar(15) not null, nummov varchar(20) not null , saldo double(19,2) default '0.00' not null) ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & nTablaDocumentosAnteriores _
                & " select a.codcli, a.nummov, sum(a.importe) as saldo " _
                & " from jsventracob a " _
                & " Where " _
                & " a.emision < '" & FormatoFechaMySQL(PrimerDiaMes(FechaActual)) & "' and " _
                & " a.id_emp = '" & jytsistema.WorkID & "' " _
                & " group by a.codcli, a.nummov " _
                & " having saldo > 0.0001 or saldo < -0.0001 ")

            EjecutarSTRSQL(myConn, lblInfo, " create temporary table " & nTablaPagos & " ( codcli varchar(15) not null, pagos double(19,2) default '0.00' not null) ")
            EjecutarSTRSQL(myConn, lblInfo, " create index " & nIndicePagos & " on " & nTablaPagos & " (codcli) ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & nTablaPagos _
                & " select a.codcli, sum(b.importe) as saldo " _
                & " from  " & nTablaDocumentosAnteriores & " a " _
                & " left join jsventracob  b on (a.nummov = b.nummov and a.codcli = b.codcli) " _
                & " Where " _
                & " b.tipomov in ('NC','ND','CA','AB') and " _
                & " b.emision >= '" & FormatoFechaMySQL(PrimerDiaMes(FechaActual)) & "' and " _
                & " b.emision <= '" & FormatoFechaMySQL(FechaActual) & "' and " _
                & " b.id_emp = '" & jytsistema.WorkID & "' " _
                & " group by a.codcli ")
        ...
        Else
            ...
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & nTablaSaldos _
                ...
                & " left join jsventracob b on (a.codcli = b.codcli and a.id_emp = b.id_emp) " _
                & " Where " _
                & " b.tipomov in ('FC','GR','ND') and " _
                & " b.emision >= '" & FormatoFechaMySQL(PrimerDiaMes(FechaActual)) & "' and " _
                & " b.emision <= '" & FormatoFechaMySQL(FechaActual) & "' and " _
                & " a.id_emp = '" & jytsistema.WorkID & "' " _
                & " group by a.codcli ")

            Tabla1 = "tbl" & Format(NumeroAleatorio(10000), "00000")
            Tabla2 = "tbl" & Format(NumeroAleatorio(10000), "00000")

            EjecutarSTRSQL(myConn, lblInfo, " create temporary table " & Tabla1 & "  ( codcli varchar(15) not null, saldo double(19,2) default '0.00' not null)  ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & Tabla1 & " select a.codcli, sum(a.importe) as saldo " _
                & " from jsventracob a " _
                & " Where " _
                & " a.emision < '" & FormatoFechaMySQL(PrimerDiaMes(FechaActual)) & "' and " _
                & " a.id_emp = '" & jytsistema.WorkID & "' " _
            ...
            EjecutarSTRSQL(myConn, lblInfo, " create temporary table " & Tabla2 & " ( codcli varchar(15) not null, saldo double(19,2) default '0.00' not null) ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & Tabla2 & " select a.codcli, sum(a.importe) as saldo " _
                & " from jsventracob a " _
                & " Where " _
                & " a.importe < 0 and " _
                & " a.emision >= '" & FormatoFechaMySQL(PrimerDiaMes(FechaActual)) & "' and " _
                & " a.emision <= '" & FormatoFechaMySQL(FechaActual) & "' and " _
                & " a.id_emp = '" & jytsistema.WorkID & "' " _
                & " group by a.codcli ")
            ...
            EjecutarSTRSQL(myConn, lblInfo, " create index " & nIndicePagos & " on " & nTablaPagos & " (codcli) ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into " & nTablaPagos _
                & " select a.codcli, if( sum(b.saldo) + a.saldo < 0, sum(b.saldo) + a.saldo, 0 )  as saldo " _
                & " from  " & Tabla1 & " a " _
                & " left join " & Tabla2 & " b on (a.codcli = b.codcli) " _
                & " group by a.codcli ")

        End If


        EjecutarSTRSQL(myConn, lblInfo, " create temporary table " & nTablaTotalSaldos & " ( codcli varchar(15), " _
            & " nombre varchar(250), " _
            & " vendedor varchar(35), " _
            & " saldo double(19,2) default '0.00', " _
            & " pagos double(19,2) default '0.00' ) ")

        EjecutarSTRSQL(myConn, lblInfo, " insert into " & nTablaTotalSaldos & " select a.codcli, a.nombre, a.vendedor, " _
            & " b.saldo, sum(c.pagos) " _
            & " from jsvencatcli a " _
            & " left join " & nTablaSaldos & " b on (a.codcli = b.codcli) " _
            & " left join " & nTablaPagos & " c on (a.codcli = c.codcli) " _
            & " where a.id_emp = '" & jytsistema.WorkID & "'  " _
            & " group by a.codcli " _
            & " order by a.codcli ")

        Dim tblTotal As String
        tblTotal = "tbl" & NumeroAleatorio(10000)

        EjecutarSTRSQL(myConn, lblInfo, "create temporary table " & tblTotal & "  (vendedor varchar(50) DEFAULT '' not null, codcli varchar(15) not null, " _
            & " nombre varchar(250), saldo double(19,2) default '0.00', pagos double(19,2) default '0.00', " _
            & " logro double(19,2) default '0.00', metadiaria double(19,2) default '0.00', " _
            & " cierre double(19,2) default '0.00' ) ")

        EjecutarSTRSQL(myConn, lblInfo, "insert into " & tblTotal & "  select concat(b.codven,' ',b.nombres,' ',b.apellidos) as vendedor, codcli, nombre, " _
            & " sum(saldo) as saldo, sum(pagos) as pagos,  if( sum(saldo) <> 0 ,-1*sum(pagos)/sum(saldo)*100, 0.00)  as logro, " _
            & " if( " & DaysToend & " <> 0, sum(saldo)/" & DaysToend & ", 0.00)  as metadiaria, sum(saldo) + sum(pagos) as cierre " _
            & " from " & nTablaTotalSaldos & " a " _
        ...
        SeleccionVENCuotasCobranza = "  select vendedor, codcli,  nombre, if(ISNULL(saldo), 0.00, saldo) saldo, " _
             & " if(ISNULL(pagos), 0.00, pagos) pagos, if(ISNULL(logro), 0.00, logro) logro, " _
             & " if(ISNULL(metadiaria), 0.00, metadiaria) metadiaria, if(ISNULL(cierre), 0.00, cierre) cierre " _
             & " From " & tblTotal _
             & " order by 1,2 "
    ...
    Function SeleccionVENBackorders(ByVal MyConn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        strFecha += " a.emision >= '" & FormatoFechaMySQL(EmisionDesde) & "' and "
        strFecha += " a.emision <= '" & FormatoFechaMySQL(EmisionHasta) & "' and "
    ...
    Function SeleccionVENRetencionesIVAClientes(ByVal FechaInicial As Date, ByVal Fechafinal As Date) As String
        ...
        Return " SELECT a.codcli , b.nombre,  a.tipomov, a.nummov, a.emision, a.refer, a.importe, a.codven, CONCAT( c.apellidos, ' ',  c.nombres) vendedor " _
            & " FROM jsventracob a " _
            & " LEFT JOIN jsvencatcli b ON (a.codcli = b.codcli AND a.id_emp = b.id_emp) " _
            & " LEFT JOIN jsvencatven c ON (a.codven = c.codven AND a.id_emp = c.id_emp) " _
            & " WHERE " _
            & " a.emision >= '" & FormatoFechaMySQL(FechaInicial) & "' AND " _
            & " a.emision <= '" & FormatoFechaMySQL(Fechafinal) & "' AND " _
    ...
    Function SeleccionVENComisionesJerarquia(AsesorDesde As String, AsesorHasta As String, _
        ...
        Return " select " _
            ...
            & " a.id_emp = '" & jytsistema.WorkID & "' and " _
            & " a.fechamov >= '" & FormatoFechaHoraMySQLInicial(EmisionDesde) & "' and " _
            & " a.fechamov <= '" & FormatoFechaHoraMySQLFinal(EmisionHasta) & "' " & strAsesor _
            & " group by " & strOrden
    ...
    Function SeleccionVENComisionesCobranzaVencimientos(AsesorDesde As String, AsesorHasta As String, _
        ...
        Return " SELECT * FROM (SELECT a.codcli, c.nombre, a.codven, CONCAT(d.apellidos, ' ', d.nombres) nomven, a.tipomov, a.nummov, a.emision, a.importe, b.numfac, b.kilos, " _
            & " b.emision emisionfac, b.tot_fac, (b.tot_net - b.descuen) montocan, DATEDIFF(a.emision, b.emision) dv,  " _
            & " IF( e.de <= DATEDIFF(a.emision, b.emision) AND DATEDIFF(a.emision, b.emision) <= e.a, e.por_cobranza , 0.00 ) porCobranza, " _
            & " (b.tot_net - b.descuen)*IF( e.de <= DATEDIFF(a.emision, b.emision) AND DATEDIFF(a.emision, b.emision) <= e.a, e.por_cobranza , 0.00 ) / 100 comisionkilos, " _
            & " e.de,  e.a " _
            & " FROM jsventracob a " _
    ...
    VendedorDesde As String, VendedorHasta As String) As String
        ...
        Dim str As String
        str = str & " a.emision >= '" & FormatoFecha(FechaDesde) & "' and a.emision <= '" & FormatoFecha(FechaHasta) & "' and "
        ...
        SeleccionComisionesCobranzaJerarquia = " select a.codven, concat(f.apellidos, ', ', f.nombres) vendedor, a.codcli,  " _
            ...
            & " from jsventracob a " _
            & " left JOIN jsbanchedev b on (a.codcli = b.prov_cli and a.numpag = b.numcheque) " _
