...
Module FuncionesCompras
    ...
    Public Function CalculaTotalIVACompras(ByVal MyConn As MySqlConnection, ByVal lblInfo As Label, _
        ...
        If DocumentoPoseeRetencionIVA(MyConn, lblInfo, NumeroDocumento, CodigoProveedor) Then
            ...
            numRetentencion = CStr(EjecutarSTRSQL_ScalarPLUS(MyConn, " select refer from jsprotrapag where " _
            ...
            fechRetencion = EjecutarSTRSQL_ScalarPLUS(MyConn, " select emision from jsprotrapag where " _
                                      & " SUBSTRING(concepto,1,13) = 'RETENCION IVA' AND " _
                                      & " TIPOMOV IN ('NC','ND') AND " _
                                      & " CODPRO = '" & CodigoProveedor & "' AND " _
                                      & " NUMMOV = '" & NumeroDocumento & "' AND " _
            ...
            montoRetencion = Math.Abs(CDbl(EjecutarSTRSQL_ScalarPLUS(MyConn, " select importe  from jsprotrapag where " _
                                      & " SUBSTRING(concepto,1,13) = 'RETENCION IVA' AND " _
                                      & " TIPOMOV IN ('NC','ND') AND " _
                                      & " CODPRO = '" & CodigoProveedor & "' AND " _
                                      & " NUMMOV = '" & NumeroDocumento & "' AND " _
        ...
        Else
            If InStr("jsvenrengas.jsvenrencom", nomTablaRenglones, ) > 0 Then
                ...
                numRetentencion = CStr(EjecutarSTRSQL_ScalarPLUS(MyConn, " select num_ret_iva from " & nomTablaRenglones.Replace("ren", "enc") & " " _
                                                                 & " where  " _
                                                                 & " " & nomCampoClave & " = '" & NumeroDocumento & "' and   " _
                                                                 & " codpro = '" & CodigoProveedor & "' and id_emp = '" & jytsistema.WorkID & "'  "))

                fechRetencion = EjecutarSTRSQL_ScalarPLUS(MyConn, " select fecha_ret_iva from " & nomTablaRenglones.Replace("ren", "enc") & " " _
                                                                 & " where  " _
                                                                 & " " & nomCampoClave & " = '" & NumeroDocumento & "' and   " _
                                                                 & " codpro = '" & CodigoProveedor & "' and id_emp = '" & jytsistema.WorkID & "'  ").ToString

                montoRetencion = CDbl(EjecutarSTRSQL_ScalarPLUS(MyConn, " select ret_iva from " & nomTablaRenglones.Replace("ren", "enc") & " " _
                                                                 & " where  " _
                                                                 & " " & nomCampoClave & " = '" & NumeroDocumento & "' and   " _
                                                                 & " codpro = '" & CodigoProveedor & "' and id_emp = '" & jytsistema.WorkID & "'  "))
            End If
        ...
        EjecutarSTRSQL_ScalarPLUS(MyConn, " update " & nomTablaIVA & " set retencion = " & montoRetencion & ", numretencion = '" & numRetentencion & "' " _
                                & " WHERE " _
                                & " " & nomCampoClave & " = '" & NumeroDocumento & "' AND " _
                                & " codpro = '" & CodigoProveedor & "' and " _
                                & " id_emp = '" & jytsistema.WorkID & "' ")
