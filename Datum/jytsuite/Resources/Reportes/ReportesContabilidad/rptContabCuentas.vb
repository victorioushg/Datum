...
Public Class rptContabCuentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Datum.rptContabCuentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContabCuentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContabCuentas = New rptContabCuentas
        rpt.Site = Me.Site
        Return rpt
    End Function
