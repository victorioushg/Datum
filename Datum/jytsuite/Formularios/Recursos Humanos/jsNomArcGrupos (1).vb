...
Public Class jsNomArcGrupos
    ...
    Private Sub AsignaTXTG2(ByVal nRow As Long, ByVal Actualiza As Boolean)
        ...
        End If
        ActivarMenuBarra(myConn, lblInfo, lRegion, ds, ds.Tables(nTablaG2), MenuBarraS2)
    ...
    Private Sub AsignaTXTG3(ByVal nRow As Long, ByVal Actualiza As Boolean)
        ...
        End If
        ActivarMenuBarra(myConn, lblInfo, lRegion, ds, ds.Tables(nTablaG3), MenuBarraS3)
    ...
    Private Sub AsignaTXTG4(ByVal nRow As Long, ByVal Actualiza As Boolean)
        ...
        End If
        ActivarMenuBarra(myConn, lblInfo, lRegion, ds, ds.Tables(nTablaG4), MenuBarraS4)
    ...
    Private Sub AsignaTXTG5(ByVal nRow As Long, ByVal Actualiza As Boolean)
        ...
        End If
        ActivarMenuBarra(myConn, lblInfo, lRegion, ds, ds.Tables(nTablaG5), MenuBarraS5)
    End Sub
