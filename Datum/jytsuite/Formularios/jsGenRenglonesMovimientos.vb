...
Public Class jsGenRenglonesMovimientos
    ...
    Private aTablasRenglones() As String = {"TRF.jsmerrentra.numtra",
                                            "PAL.jsmerrenped.numped",
                                            "PVE.jsvenrenpos.numfac",
                                            "COT.jsvenrencot.numcot",
                                            "PPE.jsvenrenpedrgv.numped",
                                            "PED.jsvenrenped.numped",
                                            "PFC.jsvenrennot.numfac",
                                            "FAC.jsvenrenfac.numfac",
                                            "NDV.jsvenrenndb.numndb",
                                            "NCV.jsvenrenncr.numncr",
                                            "NCC.jsprorenncr.numncr",
                                            "ORD.jsprorenord.numord",
                                            "REC.jsprorenrep.numrec",
                                            "GAS.jsprorengas.numgas",
                                            "COM.jsprorencom.numcom",
    ...
    Private Sub AsignarTooltips()
        'Menu Barra 
        ft.colocaToolTip(C1SuperTooltip1, jytsistema.WorkLanguage, btnCodigoArticulo, btnComentarioAdicional, btnFactura, btnLote, btnCantidadTC, _
    ...
    Private Function Validado() As Boolean
        ...
        If txtCodigo.Text.Trim() = "" Then
            ft.mensajeAdvertencia("Debe indicar una CÓDIGO válido...")
        ...
        If txtCodigo.Text.Substring(0, 1) <> "$" Then
            ...
            'EXISTENCIAS
            If (nModulo = "TRF" Or nModulo = "PAL") AndAlso CBool(ParametroPlus(MyConn, Gestion.iMercancías, "MERTRAPA01")) Then
            ...
            If ValorNumero(txtPorAceptaDev.Text) < 0 Or ValorNumero(txtPorAceptaDev.Text) > 100 Then
                ...
                ft.mensajeAdvertencia(" Debe indicar un porcentaje de aceptación válido...  ")
                Exit Function
            End If
