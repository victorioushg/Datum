...
Public Class jsContabArcActivosFijos
    ...
    Private aCondicion() As String = {"Desincorporado", "Activo"}
    ...
    Private Sub jsContabArcActivosFijos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            ft.RellenaCombo(aTipoActivo, cmbTipo)
    ...
    Private Sub AsignarTooltips()
        ...
        ft.colocaToolTip(C1SuperTooltip1, btnIngreso, btnFechaAdquisicion, btnInicioValuacion, btnGrupo, btnMoneda, btnUbica, _
                         btnCuentaActivo, btnCuentaGastos, btnCuentaRepreciacion)
    ...
    Private Sub AsignaMov(ByVal nRow As Long, ByVal Actualiza As Boolean)
        ...
        'txtFecha.Text = ft.FormatoNumero(CalculaSaldoBanco(myConn, lblInfo, txtCodigo.Text))
        'txtSaldo1.Text = txtFecha.Text
        ...
        If dt.Rows.Count > 0 Then
            With dt
                ...
                With .Rows(nRow)
                    ...
                    cmbTipo.SelectedIndex = .Item("TIPO")
                    cmbMetodo.SelectedIndex = .Item("METODO")
    ...
    Private Sub ActivarMarco0()
        ...
        ft.habilitarObjetos(True, False, btnIngreso, btnFechaAdquisicion, btnGrupo, btnMoneda, btnUbica, btnInicioValuacion, btnCuentaActivo, _
    ...
    Private Sub DesactivarMarco0()
        ...
        ft.habilitarObjetos(False, True, txtCodigo, txtCodigo1, txtDescripcion, txtNombre1, cmbCondicion, txtFecha, btnIngreso, _
                            txtGrupo, btnGrupo, txtUbica, btnUbica, txtMoneda, btnMoneda, txtTasa, txtSerial, cmbTipo, _
                            cmbMetodo, txtAdquisicion, btnFechaAdquisicion, txtAdquisicionMonto, txtSalvamento, _
    ...
    Private Sub btnPrimero_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrimero.Click
        If tbcActivos.SelectedTab.Text = "Bancos" Then
    ...
    Private Function Validado() As Boolean
        ...
        If Trim(txtAdquisicion.Text) = "" Then
    ...
    Private Sub txtCodigo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCodigo.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el código del banco ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtNombre_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDescripcion.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el nombre del banco (por favor omita la palabra banco)... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtCtaBan_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtAdquisicion.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el número de cuenta bancaria ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtAgencia_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtInicioValuacion.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el nombre de la agencia del banco ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtDireccion_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ft.mensajeEtiqueta(lblInfo, " Indique la dirección de la agencia del banco  ... ", Transportables.tipoMensaje.iInfo)
    End Sub

    Private Sub txtTelef1_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGrupo.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el número de teléfono principal ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtTelef2_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSerial.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el número de teléfono secundario ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtFax_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMoneda.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique el número de fax ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtEmail_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtUbica.GotFocus
        ft.mensajeEtiqueta(lblInfo, " Indique la dirección de correo electrónico de este banco ... ", Transportables.TipoMensaje.iInfo)
    End Sub

    Private Sub txtWeb_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ft.mensajeEtiqueta(lblInfo, " Indique el sitio web de este banco ... ", Transportables.tipoMensaje.iInfo)
    End Sub

    Private Sub txtContacto_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ft.mensajeEtiqueta(lblInfo, " Indique el nombre de la persona contacto en este banco ... ", Transportables.tipoMensaje.iInfo)
    End Sub

    Private Sub txtComision_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ft.mensajeEtiqueta(lblInfo, " Indique el porcentaje de comisión retenido por este banco ... ", Transportables.tipoMensaje.iInfo)
    End Sub

    Private Sub cmbCondicion_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ft.mensajeEtiqueta(lblInfo, " Indique el estatus o condición de este banco ... ", Transportables.tipoMensaje.iInfo)
    End Sub
