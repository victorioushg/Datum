...
Public Class jsContabProProcesarCuentas
    ...
    Public Sub Cargar(ByVal MyCon As MySqlConnection)
        ...
        myConn = MyCon
        Me.Tag = sModulo
        lblLeyenda.Text = " Mediante este proceso se recalculan los saldos de las cuentas contables " + vbCr + _
    ...
    Private Sub IniciarValores()
        ...
        lblEjercicio.Text = IIf(jytsistema.WorkExercise = "", "00000", jytsistema.WorkExercise) + _
           " | " + ft.FormatoFecha(FechaInicioEjercicio(myConn, lblInfo)) + " | " + ft.FormatoFecha(FechaCierreEjercicio(myConn, lblInfo))

        txtFechaDesde.Text = ft.FormatoFecha(FechaInicioEjercicio(myConn, lblInfo))
        txtFechaHasta.Text = ft.FormatoFecha(FechaCierreEjercicio(myConn, lblInfo))
        ...
        While FechaInicial <= CDate(txtFechaHasta.Text)
            ...
            For Each nRow As DataRow In dt.Rows
                With nRow
                    ...
                    refrescaBarraprogresoEtiqueta(ProgressBar1, lblProgreso, kCont / dt.Rows.Count * 100, ft.FormatoFecha(FechaInicial) & " | " & _
