...
Public Class jsComArcGrupoSubgrupo
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If CInt(EjecutarSTRSQL_Scalar(myConn, lblInfo, " select count(*) from jsprogrugas where antecesor = '" & dtG0.Rows(PosicionG0).Item("codigo") & "' and id_emp = '" & jytsistema.WorkID & "' ")) = 0 Then
            ...
            End If
        Else
            MensajeCritico(lblInfo, "Este Grupo tiene Subgrupos asignados...")
        End If
    ...
    Private Sub btnEliminarS1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminarS1.Click
        ...
        If NumeroDeRegistrosEnTabla(myConn, "jsproencgas", " subgrupo = '" & dtG1.Rows(PosicionG1).Item("codigo") & "' ") > 0 Then
            MensajeCritico(lblInfo, "SUBGRUPO NO ELIMINABLE...")
        Else
            Dim sRespuesta As Integer
            sRespuesta = MsgBox(" ¿ Esta Seguro que desea eliminar registro ?", vbYesNo, "Eliminar registro en " & sModulo & " ...")
            If sRespuesta = vbYes Then
