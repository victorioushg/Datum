...
Public Class jsComArcProveedoresCXP
    ...
    Private Sub btnCodigoContableIVA_Click(sender As System.Object, e As System.EventArgs) Handles btnCodigoContableIVA.Click
        txtCodigoContableIVA.Text = CargarTablaSimple(myConn, lblInfo, ds, " select codcon codigo, descripcion from jscotcatcon where id_emp = '" & jytsistema.WorkID & "' order by 1 ", "Cuentas Contables", _
    ...
    Private Sub btnCodigoContableISLR_Click(sender As System.Object, e As System.EventArgs) Handles btnCodigoContableISLR.Click
        txtCodigoContableISLR.Text = CargarTablaSimple(myConn, lblInfo, ds, " select codcon codigo, descripcion from jscotcatcon where id_emp = '" & jytsistema.WorkID & "' order by 1 ", "Cuentas Contables", _
    ...
    Private Sub btnCodigoContableDebitos_Click(sender As System.Object, e As System.EventArgs) Handles btnCodigoContableDebitos.Click
        txtCodigoContableDebitos.Text = CargarTablaSimple(myConn, lblInfo, ds, " select codcon codigo, descripcion from jscotcatcon where id_emp = '" & jytsistema.WorkID & "' order by 1 ", "Cuentas Contables", _
