...
Public Class jsComRepParametros
    ...
    Private Sub btnCategoriaDesde_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCategoriaDesde.Click
        txtCategoriaDesde.Text = CargarTablaSimple(myConn, lblInfo, ds, " select codigo, descrip descripcion from jsproliscat where id_emp = '" & jytsistema.WorkID & "' order by codigo  ", "Categorías", txtCategoriaDesde.Text)
    End Sub
    ...
    Private Sub btnCategoriaHasta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCategoriaHasta.Click
        txtCategoriaHasta.Text = CargarTablaSimple(myConn, lblInfo, ds, " select codigo, descrip descripcion from jsproliscat where id_emp = '" & jytsistema.WorkID & "' order by codigo  ", "Categorías", txtCategoriaHasta.Text)
    End Sub
