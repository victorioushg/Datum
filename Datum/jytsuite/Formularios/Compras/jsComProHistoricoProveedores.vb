...
Public Class jsComProHistoricoProveedores
    ...
    Public Sub Cargar(ByVal MyCon As MySqlConnection, ByVal TipoProceso As Integer, Optional ByVal CodCliente As String = "", _
        ...
        If dt.Rows.Count > 0 Then
            ...
            For jCont = 0 To dt.Rows.Count - 1
                With dt.Rows(jCont)
                    ...
                    Else
                        ReversarDeHistoricoCXP(.Item("codpro"), CDate(txtFechaProceso.Text))
                    End If
                End With
    ...
    Private Sub btnFecha_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFecha.Click
        txtFechaProceso.Text = SeleccionaFechaPlus(CDate(txtFechaProceso.Text), CDate(txtFechaProceso.Text), True, btnFecha)
    End Sub
