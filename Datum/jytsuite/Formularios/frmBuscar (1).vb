...
Public Class frmBuscar
    ...
    Public Sub Buscar(ByVal dt As DataTable, ByVal FieldArray() As String, _
        ByVal FieldNameArray() As String, ByVal FieldWidthArray() As Long, _
    ...
    Private Sub dg_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles _
        ...
        Select Case dg.Columns(e.ColumnIndex).Name
            Case "emision", "fechamov", "vence", "ingreso", "fechasi"
                e.Value = FormatoFechaCorta(CDate(e.Value.ToString))
        End Select
    End Sub
