...
Public Class jsSIGMERepParametros
    ...
    Private aTipoReporte() As String = {"Unidad Venta", "Peso", "Monetarios"}
    ...
    Private Sub IniciarGrupos()
        ...
        If ReporteNumero = ReporteMedicionGerencial.cVentasMesMesAsesor Then
            RellenaCombo(vMERAgrupadoPorR, cmbMERAgrupadoPor)
        ElseIf ReporteNumero = ReporteMedicionGerencial.cVentasComprasExistenciasMesMes Then
            RellenaCombo(vMERAgrupadoPorJ, cmbMERAgrupadoPor)
        Else
        ...
        HabilitarObjetos(False, False, TabPageVentas, TabPageCompras)
        ...
        Select Case ReporteNumero
            ...
            Case ReporteMedicionGerencial.cComprasComparativasMesMes
                HabilitarObjetos(True, False, TabPageCompras)
        End Select
    ...
    Private Sub VerCriterio_Año(ByVal ver As Boolean)
        ...
        'HabilitarObjetos(False, True, cmbAño)
    End Sub
    ...
    Private Sub IniciarConstantes()
        ...
        Select Case ReporteNumero
            ...
            Case ReporteMedicionGerencial.cDescuentosAsesor, ReporteMedicionGerencial.cDescuentosAsesorMesMes
                ...
                RellenaCombo(atipoR, cmbTipoReporte, 6)
                verConstante_TipoReporte(True)
    ...
    Private Sub verConstante_ResumenMercas(ByVal Ver As Boolean)
        VisualizarObjetos(Ver, lblChkMercas, chkResumenMercas)
    End Sub
    ...
    Private Sub cmbCOMAgrupadoPor_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCOMAgrupadoPor.SelectedIndexChanged
        VisualizarObjetos(False, lblGrupoProveedorDesde, lblGrupoProveedorHasta, lblCategoriaProveedor, lblUnidadProveedor, _
    ...
    Private Sub VerCategoriasProveedor()
        VisualizarObjetos(True, lblGrupoProveedorDesde, lblGrupoProveedorHasta)
        VisualizarObjetos(True, lblCategoriaProveedor, txtCategoriaProveedorDesde, btnCategoriaProveedorDesde, txtCategoriaProveedorHasta, btnCategoriaProveedorHasta)
        HabilitarObjetos(False, True, txtCategoriaProveedorDesde, txtCategoriaProveedorHasta)
    End Sub
    Private Sub VerUnidadProveedor()
        VisualizarObjetos(True, lblGrupoProveedorDesde, lblGrupoProveedorHasta)
        VisualizarObjetos(True, lblUnidadProveedor, txtUnidadProveedorDesde, btnUnidadProveedorDesde, txtUnidadProveedorHasta, btnUNidadProveedorHasta)
        HabilitarObjetos(False, True, txtUnidadProveedorDesde, txtUnidadProveedorHasta)
    End Sub
