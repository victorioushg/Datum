...
Public Class jsSIGMERepParametrosPlus
    ...
    Private Sub jsSIGMERepParametrosPlus_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ft = Nothing
    End Sub
    ...
    Private Sub cmbMERAgrupadorPor_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

        'ft.visualizarObjetos(False, lblCategoriasSeleccion, lblGrupoHasta, lblCategoria, lblMarcas, lblDivisiones, lblJerarquias, _
    ...
    Private Sub VerCategorias()
        ft.visualizarObjetos(True, lblCategoriasSeleccion, lblMarcasSeleccion)
    ...
    Private Sub VerMarcas()
        ft.visualizarObjetos(True, lblCategoriasSeleccion, lblMarcasSeleccion)
        'ft.visualizarObjetos(True, lblMarcas, txtMarcaDesde, btnMarcas, txtMarcaHasta, btnMarcaHasta)
    ...
    Private Sub txtCategoriaDesde_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'txtCategoriaHasta.Text = txtCategoriaDesde.Text
    End Sub

    Private Sub txtMarcaDesde_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'txtMarcaHasta.Text = txtMarcaDesde.Text
    End Sub

    Private Sub txtDivisionDesde_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'txtDivisionHasta.Text = txtDivisionDesde.Text
    End Sub

    Private Sub btnCategoriaDesde_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCategorias.Click
    ...
    Private Sub btnCategoriaHasta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim fg As New jsControlArcTablaSimple
        'fg.Cargar("Categorías", FormatoTablaSimple(Modulo.iCategoriaMerca), True, TipoCargaFormulario.iShowDialog)
    ...
    Private Sub btnMarcaDesde_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMarcas.Click
    ...
    Private Sub btnMarcaHasta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim f As New jsControlArcTablaSimple
        'f.Cargar("Marcas", FormatoTablaSimple(Modulo.iMarcaMerca), True, TipoCargaFormulario.iShowDialog)
    ...
    Private Sub btnDivisionHasta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim f As New jsControlArcDivisiones
        'f.Cargar(myConn, TipoCargaFormulario.iShowDialog)
