...
Public Class jsBanArcBancos
    ...
    Private Sub jsBanBancos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            ft.RellenaCombo(aTitulos, cmbTitulo)
    ...
    Private Sub AsignarTooltips()
        ...
        ft.colocaToolTip(C1SuperTooltip1, btnIngreso, btnFormatos, btnCuentaContable)
        ...
        If dt.Rows.Count > 0 Then
            With dt
                ...
                With .Rows(nRow)
                    ...
                    txtIngreso.Text = ft.muestraCampoFecha(.Item("fechacrea"))
                    ...
                    cmbTitulo.SelectedIndex = IIf(ft.InArray(aTitulos, .Item("titulo")) < 0, 0, ft.InArray(aTitulos, .Item("titulo")))
    ...
    Private Sub ActivarMarco0()
        ...
        ft.habilitarObjetos(True, True, txtNombre, txtCtaBan, txtAgencia, txtDireccion, txtTelef1, txtTelef2, _
                    txtFax, txtEmail, txtWeb, txtContacto, cmbTitulo, btnCuentaContable, btnIngreso, _
    ...
    Private Sub DesactivarMarco0()
        ...
        ft.habilitarObjetos(False, True, txtCodigo, txtCodigo1, txtNombre, txtNombre1, txtCtaBan, txtCtaBan1, txtSaldo, _
                            txtAgencia, txtDireccion, txtTelef1, txtTelef2, txtFax, txtEmail, txtWeb, cmbTitulo, txtContacto, _
                            txtCuentaContable, btnCuentaContable, txtIngreso, btnIngreso, txtComision, txtFormato, btnFormatos, _
