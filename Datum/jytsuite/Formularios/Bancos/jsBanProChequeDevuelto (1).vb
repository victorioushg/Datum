...
Public Class jsBanProChequeDevuelto
    ...
    Public Sub Cargar(ByVal MyCon As MySqlConnection)
        ...
        MensajeEtiqueta(lblInfo, "Seleccione o indique el cheque a devolver, escoja la fecha y la causa de devolución ... ", TipoMensaje.iAyuda)
    ...
    Private Function Validado() As Boolean
        ...
        If txtCliente.Text = "" Then
            MensajeAdvertencia(lblInfo, " Este documento no tiene cliente válido...")
            Return False
        End If

        If txtCheque.Text = "" Then
            MensajeAdvertencia(lblInfo, " Debe indicar un número de cheque válido...")
            Return False
        End If

        If txtEstatus.Text = "Devuelto" Then
            MensajeAdvertencia(lblInfo, "Este cheque YA está devuelto...")
            Return False
        End If
    ...
    Private Sub DebitosEnCXC()
        ...
        Dim strX As String = RellenaCadenaConCaracter("-------------------------------", "D", 80) & _
                             ...
                             RellenaCadenaConCaracter("EN EL AÑO : " & Format(jytsistema.sFechadeTrabajo, "yyyy") & "   " & FormatoEntero(ChequesAno), "D", 80) & _
    ...
    Private Sub txtCancelacion_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCancelacion.TextChanged
        ...
        Dim aNombres() As String = {"TP", "Emisión", "Documento", "Importe"}
