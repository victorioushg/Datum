...
Public Class jsBanRepParametros
    ...
    Public Sub Cargar(ByVal TipoCarga As Integer, ByVal numReporte As Integer, ByVal nomReporte As String, _
        ...
        RellenaCombo(aInNOTIn, cmbOrigen)
    ...
    Private Sub HabilitarTabs(ByVal Orden As Boolean, ByVal GRupo As Boolean, ByVal Criterio As Boolean, ByVal Constante As Boolean)
        ...
        HabilitarObjetos(Orden, False, grpOrden)
        HabilitarObjetos(GRupo, False, grpGrupos)
        HabilitarObjetos(Criterio, False, grpCriterios)
        HabilitarObjetos(Constante, False, grpConstantes)
    ...
    Private Sub VerCriterio_TipoDocumento(ByVal ver As Boolean, Optional ByVal DocumentosTipo As Integer = 0)
        ...
        HabilitarObjetos(ver, True, lblTipodocumento, chkList)
    ...
    Private Sub VerCriterio_MesAño(ByVal ver As Boolean)
        VisualizarObjetos(ver, lblMesAño, lblMes, lblAño, cmbMes, cmbAño)
        IniciarCriterioMesAño()
    End Sub
    Private Sub VerCriterio_Origen(ver As Boolean)
        VisualizarObjetos(ver, lblOrigen, cmbOrigen, btnOrigen, lblOrigenSeleccion)
    End Sub
    Private Sub VerCriterio_Documento(ByVal ver As Boolean)

        VisualizarObjetos(ver, lblDocHasta, lblDocDesde, lblDocumento, txtDocumentoDesde, txtDocumentoHasta)
    ...
    Private Sub VerCriterio_Deposito(ByVal ver As Boolean)
        ...
        VisualizarObjetos(ver, Label1, Label2, Label3, txtDepositoDesde, txtDepositoHasta)
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        Select Case ReporteNumero
            ...
            Case ReporteBancos.cReposicionSaldoCaja
                ...
                str = SeleccionBANReposicionSaldoCaja(txtOrdenDesde.Text, txtDocumentoHasta.Text)
            Case ReporteBancos.cResumenReposicionSaldoCaja
                nTabla = "dtDepositos"
                oReporte = New rptBanReposisionSaldoCaja
                str = SeleccionBANReposicionSaldoCaja(txtOrdenDesde.Text, txtDocumentoHasta.Text, CDate(txtPeriodoDesde.Text), CDate(txtPeriodoHasta.Text))
    ...
    Private Function PresentaReporte(ByVal oReporte As CrystalDecisions.CrystalReports.Engine.ReportClass, _
        ...
        Select Case ReporteNumero
            ...
            Case ReporteBancos.cConciliacion
                oReporte.SetParameterValue("SaldoAl", " Saldo al " + FormatoFecha(DateAdd(DateInterval.Day, -1, CDate("01/" + Format(cmbMes.SelectedIndex + 1, "00") + "/" + CStr(cmbAño.SelectedIndex + 2000)))))
            Case ReporteBancos.cEstadoCuenta
                oReporte.SetParameterValue("SaldoAl", " Saldo al " + FormatoFecha(DateAdd(DateInterval.Day, -1, CDate(txtPeriodoDesde.Text))))
            Case ReporteBancos.cDepositos
            ...
            Case ReporteBancos.cComprobanteDeEgreso, ReporteBancos.cCheque
                ...
                Dim MontoEgreso As Double = Math.Abs(CDbl(EjecutarSTRSQL_Scalar(myConn, lblInfo, " select importe from jsbantraban where codban = '" & CodigoBanco & "' and comproba = '" & Documento & "' and id_emp = '" & jytsistema.WorkID & "' ").ToString))
                ...
                oReporte.SetParameterValue("MontoEnNumeros", "***" + FormatoNumero(MontoEgreso) + "***")
            ...
            Case ReporteBancos.cFormatoCheque
                ...
                oReporte.SetParameterValue("MontoEnNumeros", "***" + FormatoNumero(1234567.89) + "***")
