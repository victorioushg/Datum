...
Public Class jsPOSArcSupervisores

    Private Const sModulo As String = "Supervisores"
    Private Const lRegion As String = "RibbonButton93"
    ...
    Private strSQL As String = "select * from jsvencatsup where id_emp ='" & jytsistema.WorkID & "'  order by codigo "
    ...
    End Sub
    Private Sub jsPOSArcSupervisores_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        dt = Nothing
        ds = Nothing
    End Sub

    Private Sub jsPOSArcSupervisores_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"codigo", "descrip", "nombre", ""}
        Dim aNombres() As String = {"Código", "Descripción", "Nombre", ""}
        Dim aAnchos() As Long = {70, 250, 250, 10}
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Dim f As New jsPOSArcSupervisorMovimientos
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = vbYes Then
            ...
            With dt.Rows(Posicion)
                Dim aString() As String = {.Item("codigo"), jytsistema.WorkID}
                EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsvencatsup", strSQL, aCampos, aString, Posicion)
            End With
        End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        f.Buscar(dt, Campos, Nombres, Anchos, Me.BindingContext(ds, nTabla).Position, "Supervisores de puntos de venta...")
