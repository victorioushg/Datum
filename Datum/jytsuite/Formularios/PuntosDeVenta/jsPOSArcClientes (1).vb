...
Public Class jsPOSArcClientes
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Long = {140, 300, 600, 140, 70}
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = vbYes Then
            ...
            EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsvencatclipv", strSQL, aCampos, aString, dg.CurrentRow.Index)
        End If
        AsignaTXT(Posicion, True)
    End Sub
    ...
    Private Sub dg_RowValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg.RowValidated
        ...
        Select Case dg.CurrentCell.ColumnIndex
            ...
            Case 1
                EjecutarSTRSQL(myConn, lblInfo, " update jsvencatclipv set nombre = '" & dg.CurrentCell.Value & "' " _
                                       & " where rif = '" & dg.CurrentRow.Cells(0).Value & "' and id_emp = '" & jytsistema.WorkID & "' ")
                AsignaTXT(Posicion, True, dg.CurrentCell.ColumnIndex)
            Case 2
                EjecutarSTRSQL(myConn, lblInfo, " update jsvencatclipv set dirfiscal = '" & dg.CurrentCell.Value & "' " _
                                       & " where rif = '" & dg.CurrentRow.Cells(0).Value & "' and id_emp = '" & jytsistema.WorkID & "' ")
                AsignaTXT(Posicion, True, dg.CurrentCell.ColumnIndex)
            Case 3
                EjecutarSTRSQL(myConn, lblInfo, " update jsvencatclipv set telef1 = '" & dg.CurrentCell.Value & "' " _
                                       & " where rif = '" & dg.CurrentRow.Cells(0).Value & "' and id_emp = '" & jytsistema.WorkID & "' ")
                AsignaTXT(Posicion, True, dg.CurrentCell.ColumnIndex)
        End Select
