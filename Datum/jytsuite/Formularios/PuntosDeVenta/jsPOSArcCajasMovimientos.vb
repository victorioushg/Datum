...
Public Class jsPOSArcCajasMovimientos
    ...
    Private Sub IniciarTXT()
        ...
        txtCodigo.Text = ft.autoCodigo(MyConn, "codcaj", "jsvencatcaj", "id_emp", jytsistema.WorkID, 5)
        txtNombre.Text = ""
        txtAlmacen.Text = ""
        txtImpreFiscal.Text = ""
        txtImpreFiscal.Text = ""
    ...
    Private Sub jsPOSArcCajasMovimientos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ft.habilitarObjetos(False, True, txtCodigo, txtAlmacen, txtImpreFiscal)
    ...
    Private Sub txtCodigo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCodigo.GotFocus, _
        ...
        Select Case sender.name
            Case "txtCodigo"
                ft.mensajeEtiqueta(lblInfo, "Indique el código de caja ...", Transportables.TipoMensaje.iInfo)
            Case "txtNombre"
                ft.mensajeEtiqueta(lblInfo, "Indique el nombre o descripción caja ó punto de venta ...", Transportables.TipoMensaje.iInfo)
            Case "txtAlmacen"
                ft.mensajeEtiqueta(lblInfo, "Indique el código de almacén ...", Transportables.TipoMensaje.iInfo)
    ...
    Private Sub btnCancel_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        If i_modo = movimiento.iAgregar Then
            ft.Ejecutar_strSQL(myconn, " delete from jsvenpervencaj where codcaj = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "'")
        End If
        Me.Close()
    End Sub
    ...
    Private Sub btnAgregaTarjeta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregaPerfil.Click
        ...
        If f.Seleccionado <> "" Then
            ft.Ejecutar_strSQL(MyConn, " replace into jsvenpervencaj set codcaj = '" & txtCodigo.Text & "', codper = '" & f.Seleccionado & "', id_emp = '" & jytsistema.WorkID & "' ")
            dsLocal = DataSetRequery(dsLocal, strSQLPer, MyConn, nTablaPer, lblInfo)
            dtRenglon = dsLocal.Tables(nTablaPer)
