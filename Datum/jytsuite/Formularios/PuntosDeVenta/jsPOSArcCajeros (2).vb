...
Public Class jsPOSArcCajeros
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"codven", "apellidos", "tipo", ""}
        Dim aNombres() As String = {"Código", "Nombre", "Tipo", ""}
        Dim aAnchos() As Long = {70, 350, 100, 10}
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = vbYes Then
            ...
            With dt.Rows(Posicion)
                ...
                EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsvencatven", strSQL, aCampos, aString, Posicion)
            End With
        End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Dim Campos() As String = {"codven", "nombre"}
