...
Public Class jsPOSArcFacturas
    ...
    Private Sub Imprimir()
        ...
        If DocumentoImpreso(myConn, lblInfo, "jsvenencpos", "numfac", txtCodigo.Text) Then
            ...
            ' MensajeCritico(lblInfo, "Este documento YA fué impreso...")
            'Else
    ...
    Private Function Validado() As Boolean
        ...
        If txtNombreAsesor.Text = "" Then
            MensajeCritico(lblInfo, "Debe indicar un nombre de Cajero válido...")
            Return False
        End If

        If txtNombreTransporte.Text = "" Then
            MensajeCritico(lblInfo, "Debe indicar una caja válida...")
            Return False
        End If
    ...
    Private Sub btnEditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEditar.Click
        ...
        MensajeInformativo(lblInfo, "Mercancías actualizadas...")
