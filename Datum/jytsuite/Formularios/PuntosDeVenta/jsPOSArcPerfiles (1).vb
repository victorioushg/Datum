...
Public Class jsPOSArcPerfiles
    Private Const sModulo As String = "Perfiles de facturación para puntos de venta"
    ...
    Private strSQL As String = "select * from jsvenperven where id_emp = '" & jytsistema.WorkID & "' order by codper"
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"codper", "descrip", "CR", "CO", "TARIFA_A", "TARIFA_B", "TARIFA_C", "TARIFA_D", "TARIFA_E", "TARIFA_F", "ALMACEN", "DESCUENTO"}
        Dim aNombres() As String = {"Código", "Nombre", "Crédito", "Contado", "Tarifa A", "Tarifa B", "Tarifa C", "Tarifa D", "Tarifa E", "Tarifa F", "Almacén", "Descuento"}
        Dim aAnchos() As Long = {70, 150, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70}
        Dim aAlineacion() As Integer = {DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleLeft, _
            DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleCenter, _
            DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleCenter, _
            DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleCenter, DataGridViewContentAlignment.MiddleCenter, _
            DataGridViewContentAlignment.MiddleCenter}
        Dim aFormatos() As String = {"", "", sFormatoEntero, sFormatoEntero, sFormatoEntero, sFormatoEntero, sFormatoEntero, sFormatoEntero, sFormatoEntero, sFormatoEntero, "", sFormatoEntero}
        IniciarTabla(dg, dt, aCampos, aNombres, aAnchos, aAlineacion, aFormatos)
    End Sub

    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Dim f As New jsPOSArcPerfilesMovimientos
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = vbYes Then
            Dim aCampos() As String = {"codper", "id_emp"}
            Dim aString() As String = {dt.Rows(Posicion).Item("codper"), jytsistema.WorkID}
            EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsvenperven", strSQL, aCampos, aString, Posicion)
        End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Dim Campos() As String = {"codper", "descrip"}
        Dim Nombres() As String = {"Código", "Nombre PERFIL"}
        Dim Anchos() As Long = {100, 2500}
        f.Buscar(dt, Campos, Nombres, Anchos, Me.BindingContext(ds, nTabla).Position, "PERFILES DE FACTURACION ...")
    ...
    Private Sub btnSeleccionar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSeleccionar.Click
        ...
        If dt.Rows.Count > 0 Then
            Seleccionado = dt.Rows(Posicion).Item("codper").ToString
    ...
    Private Sub dg_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dg.CellFormatting
        Select Case dg.Columns(e.ColumnIndex).Name
            Case "CR", "CO", "TARIFA_A", "TARIFA_B", "TARIFA_C", "TARIFA_D", "TARIFA_E", "TARIFA_F"
                Select Case e.Value
                    Case 0
                        e.Value = "No"
                    Case 1
                ...
                End Select
            Case "DESCUENTO"
                e.Value = IIf(e.Value = 0, "NO", IIf(e.Value = 1, "POR DEFECTO", "ASESOR"))
        End Select
    End Sub
