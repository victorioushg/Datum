...
Imports fTransport
Public Class jsMerArcListaSeleccionCostosPrecios
    ...
    Private Sub AsignaTXT(ByVal nRow As Long, ByVal Actualiza As Boolean)
        ...
        If Actualiza Then ds = ft.DataSetRequery(ds, nTabla, myConn, strSQL)
        '    dt = ds.Tables(nTabla)
        'End If
    ...
    Private Sub IniciarGrilla(ByVal TipoLista As Integer)
        Select Case TipoLista
            Case TipoListaPrecios.Normal
                ...
                Dim aAnchos() As Integer = {80, 300, 30, 70, 40}
            ...
            Case TipoListaPrecios.Costos, TipoListaPrecios.CostosTodos
                ...
                Dim aAnchos() As Integer = {80, 300, 80, 30, 100, 40, 100, 100, 140}
            ...
            Case TipoListaPrecios.CostosSugerido
                ...
                Dim aCampos() As String = {"codart.Código.80.I.", _
                                           ...
                                           "inventario.Inventario (Días).90.C.Entero", _
                                           "sugerido.Sugerido.90.D.Cantidad", "unidad.UND.40.C.", _
                                           "montoultimacompra.Ultimo costo.110.D.Numero"}
                
                ft.IniciarTabla(dg, dt, aCampos, , , , , , , False)

                Visualizar(2)
                Dim aAnchos() As Integer = {80, 350, 80, 30, 90, 90, 90, 40, 110}
                ArreglaAnchoVentana(aAnchos)
            ...
            Case TipoListaPrecios.Precios
                ...
                Dim aAnchos() As Integer = {80, 300, 30, 65, 40, 60, 60, 60, 60, 60, 60}
    ...
    End Sub
    Private Sub ArreglaAnchoVentana(aArray() As Integer)
