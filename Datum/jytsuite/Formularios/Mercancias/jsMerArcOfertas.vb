...
Public Class jsMerArcOfertas
    ...
    Private Sub jsMerArcOfertas_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ft = Nothing
    End Sub
    ...
    Private Sub IniciarDocumento(ByVal Inicio As Boolean)
        ...
        If Inicio Then
            txtOferta.Text = "OF" & ft.NumeroAleatorio(10000000)
        Else
            txtOferta.Text = ""
        End If
    ...
    Private Sub AgregaYCancela()
        ft.Ejecutar_strSQL(myconn, " delete from jsmerrenofe where codofe = '" & txtOferta.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
        ft.Ejecutar_strSQL(myconn, " delete from jsmerrenbon where codofe = '" & txtOferta.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    End Sub
    ...
    Private Sub GuardarTXT()
        ...
        If i_modo = movimiento.iAgregar Then
            ...
            Codigo = ft.autoCodigo(myConn, "codofe", "jsmerencofe", "id_emp", jytsistema.WorkID, 8)
            ft.Ejecutar_strSQL(myconn, " update jsmerrenofe set codofe = '" & Codigo & "' where codofe = '" & txtOferta.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
            ft.Ejecutar_strSQL(myconn, " update jsmerrenbon set codofe = '" & Codigo & "' where codofe = '" & txtOferta.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If ft.PreguntaEliminarRegistro() = Windows.Forms.DialogResult.Yes Then
            ...
            ft.Ejecutar_strSQL(myConn, " delete from jsmerencofe where " _
