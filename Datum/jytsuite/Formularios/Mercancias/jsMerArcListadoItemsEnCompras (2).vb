...
Public Class jsMerArcListadoItemsEnCompras
    ...
    Dim aCampos() As String = {"numCOM", "emision", "cantidad", "unidad", "COSTOU", "COSTOTOTDES", "codPRO", ""}
    Dim aNombres() As String = {"N° de Factura", "Fecha Emisión", "Cantidad", "UND", "COSTO Unitario", "COSTO Total", "Código PROVEEDOR", ""}
    Dim aAnchos() As Long = {150, 100, 100, 50, 100, 100, 100, 100}
