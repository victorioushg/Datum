...
Public Class jsMerArcPreciosEspecialesMovimientos
    ...
    Private Sub Habilitar()
        ...
        If i_modo = movimiento.iEditar Then _
            ft.habilitarObjetos(False, True, btnCodigo)
    End Sub
    ...
    Private Function Validado() As Boolean
        ...
        If i_modo = movimiento.iAgregar AndAlso _
           NumeroDeRegistrosEnTabla(MyConn, "jsmerrenlispre", " codart = '" & txtCodigo.Text & "' AND codlis = '" & NumeroLista & "' ") > 0 Then
            ft.MensajeCritico("Esta MERCANCIA ya existe enm la lista. Verifique por favor...")
            btnCodigo.Focus()
            Exit Function
        End If

        If ValorNumero(txtPrecio.Text) <= 0.0 Then
            ft.mensajeAdvertencia("Precio especial no puede ser CERO (0.00). Veriqfique por favor ")
