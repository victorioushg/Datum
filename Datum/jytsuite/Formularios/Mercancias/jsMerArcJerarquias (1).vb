...
Public Class jsMerArcJerarquias
    ...
    Private Sub ActivarMarco0()
        ...
        HabilitarObjetos(True, True, txtTipjerNombre, txtMascara1, _
        ...
        HabilitarObjetos(True, False, MenuBarraS1, MenuBarraS2, MenuBarraS3, MenuBarraS4, MenuBarraS5, MenuBarraS6)
    ...
    Private Sub DesactivarMarco0()
        HabilitarObjetos(False, True, txtTipJer, txtTipjerNombre, txtJerarquia, txtMascara1, _
                ...
                btnProveedor, txtNombreProveedor)
        HabilitarObjetos(False, False, MenuBarraS1, MenuBarraS2, MenuBarraS3, MenuBarraS4, MenuBarraS5, MenuBarraS6)
        ...
        If dt.Rows.Count > 0 Then
            ...
            With dt
                ...
                With .Rows(nRow)
                    ...
                    txtMascara1.Text = MuestraCampoTexto(.Item("mascara1"))
                    txtMascara2.Text = MuestraCampoTexto(.Item("mascara2"))
                    txtMascara3.Text = MuestraCampoTexto(.Item("mascara3"))
                    txtMascara4.Text = MuestraCampoTexto(.Item("mascara4"))
                    txtMascara5.Text = MuestraCampoTexto(.Item("mascara5"))
                    txtMascara6.Text = MuestraCampoTexto(.Item("mascara6"))

                    txtDescrip1.Text = MuestraCampoTexto(.Item("descrip1"))
                    txtDescrip2.Text = MuestraCampoTexto(.Item("descrip2"))
                    txtDescrip3.Text = MuestraCampoTexto(.Item("descrip3"))
                    txtDescrip4.Text = MuestraCampoTexto(.Item("descrip4"))
                    txtDescrip5.Text = MuestraCampoTexto(.Item("descrip5"))
                    txtDescrip6.Text = MuestraCampoTexto(.Item("descrip6"))

                    txtCodigoProveedor.Text = MuestraCampoTexto(.Item("proveedor"))
    ...
    Private Sub IniciarTipoJerarquia(ByVal Inicio As Boolean)
        ...
        If Inicio Then
            txtTipJer.Text = AutoCodigo(5, ds, nTabla, "tipjer")
        Else
            txtTipJer.Text = ""
        End If
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = MsgBoxResult.Yes Then
            ...
            EjecutarSTRSQL(myConn, lblInfo, " delete from jsmerencjer where " _
                & " tipjer = '" & txtTipJer.Text & "' AND " _
                & " ID_EMP = '" & jytsistema.WorkID & "'")

            EjecutarSTRSQL(myConn, lblInfo, " delete from jsmerrenjer where tipjer = '" & txtTipJer.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
            ds = DataSetRequery(ds, strSQL, myConn, nTabla, lblInfo)
            dt = ds.Tables(nTabla)
    ...
    Private Sub GuardarTXT()
        ...
        InsertEditMERCASEncabezadoJerarquia(myConn, lblInfo, Inserta, txtTipJer.Text, _
                                                ...
                                                txtDescrip5.Text, txtDescrip6.Text, txtCodigoProveedor.Text)
