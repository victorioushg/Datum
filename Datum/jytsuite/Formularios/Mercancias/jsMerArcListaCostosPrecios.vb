...
Public Class jsMerArcListaCostosPrecios
    ...
    Public Sub Cargar(ByVal Mycon As MySqlConnection, ByVal TipoLista As Integer, _
        ...
        If TipoLista = TipoListaPrecios.CostosSugerido Then rBtn1.Checked = True
    ...
    End Sub
    Private Sub IniciarCadena(Tipolista As Integer, proveedor As String, EstatusMercancia As Integer, Almacen As String)
        ...
        strAlmacen = IIf(Almacen <> "", " b.almacen = '" & Almacen & "' and ", "")

        If Tipolista = TipoListaPrecios.CostosSugerido Then


            strSQL = " SELECT a.codart, c.nomart, c.alterno, c.iva, SUM(IF( ISNULL(f.uvalencia), a.existencia, a.existencia/f.equivale)) existencia , " _
                ...
                & " c.unidad, c.montoultimacompra " _
    ...
    Private Sub Iniciar(ByVal strSQL As String, ByVal TipoLista As Integer, ByVal Almacen As String)
        ...
        'IniciarCadena(TipoLista, CodigoProveedor, EstatusMercancia, CodigoAlmacen)
    ...
    Private Sub rBtn1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rBtn1.CheckedChanged, rBtn2.CheckedChanged
        ...
        IniciarCadena(nTipoLista, IIf(rBtn1.Checked, CodigoProveedor, ""), EstatusMercancia, CodigoAlmacen)

        If _Control > 0 Then CambiarGrilla()
        _Control += 1
