...
Public Class jsMerArcServicios
    ...
    Private strSQL As String = "select * from jsmercatser where id_emp = '" & jytsistema.WorkID & "' order by codser "
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Long = {80, 300, 30, 100, 70, 150, 70}
    ...
    Private Sub AbrirMovimientos(ByVal CodigoArticulo As String)
        ...
        Dim aAnchos() As Long = {80, 25, 90, 35, 50, 80, 80, 80, 80, 35, 80, 280, 50, 100}
    ...
    Private Sub EliminaServicio()
        ...
        sRespuesta = MsgBox(" ¿ Esta Seguro que desea eliminar registro ?", MsgBoxStyle.YesNo, "Eliminar registro " & dt.Rows(nPosicionCat).Item("codser") & "... ")
        If sRespuesta = MsgBoxResult.Yes Then
            ...
            Else
                MensajeCritico(lblInfo, "Este SERVICIO posee movimientos. Verifique por favor ...")
            End If
        End If
    End Sub
    ...
    Private Function TablaCompras(ByVal nArticulo As String, ByVal CantidadKilosMoney As Integer, Optional ByVal AñosAtras As Integer = 0) As DataTable
        ...
        Dim tblTemp As String = "tblTemp" & NumeroAleatorio(10000)
        Select Case CantidadKilosMoney
            Case 0 ' Cantidad

                EjecutarSTRSQL(myConn, lblInfo, " DROP TABLE IF EXISTS " & tblTemp & " ")
                EjecutarSTRSQL(myConn, lblInfo, " CREATE TABLE " & tblTemp & " " _
