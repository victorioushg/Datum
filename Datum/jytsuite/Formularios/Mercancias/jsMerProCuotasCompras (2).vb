        ...
        For Each nRow As DataRow In dt.Rows
            ...
            For Each nCol As DataColumn In dt.Columns
                If nCol.ColumnName.Substring(0, 3) = "000" Then
                    ...
                    Dim nCantidad As Double = nRow.Item(nCol.ColumnName)


                    EjecutarSTRSQL(myConn, lblInfo, " update jsvencuoart set REMES" & nMonth & " = REMES" & nMonth & " + " & nCantidad & " " _
            ...
            '2. EN EL CIERRE DE MES SE DEBEN TRANSFERIR LAS CUOTAS AL MES SIGUIENTE ??????
        Next
