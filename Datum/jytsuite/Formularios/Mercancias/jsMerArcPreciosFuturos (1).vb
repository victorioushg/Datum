...
Public Class jsMerArcPreciosFuturos
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Long = {70, 90, 350, 40, 50, 70, 70, 70}
        ...
        If Posicion >= 0 Then
            ...
            If sRespuesta = MsgBoxResult.Yes Then
                With dt.Rows(Posicion)
                    ...
                    Dim aStringsDel() As String = {FormatoFechaMySQL(.Item("fecha").ToString), .Item("codart"), .Item("tipoprecio"), jytsistema.WorkID}
