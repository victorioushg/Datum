...
Public Class jsVenArcNotasEntrega
    ...
    Private Sub btnEditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEditar.Click
        ...
        If CBool(ParametroPlus(MyConn, Gestion.iVentas, "VENNOTPA01")) Then
            ...
            HabilitarObjetos(IIf(dtRenglones.Rows.Count > 0, False, True), True, txtCliente, btnCliente)
        Else
            MensajeCritico(lblInfo, "Edición de Notas de Entrega NO está permitida...")
        End If
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If CBool(ParametroPlus(MyConn, Gestion.iVentas, "VENNOTPA01")) Then
            ...
            If sRespuesta = MsgBoxResult.Yes Then
                ...
                EjecutarSTRSQL(myConn, lblInfo, " delete from jsvenivanot where numfac = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
                EjecutarSTRSQL(myConn, lblInfo, " delete from jsvenrencom where numdoc = '" & txtCodigo.Text & "' and origen = 'PFC' and id_emp = '" & jytsistema.WorkID & "' ")
                EjecutarSTRSQL(myConn, lblInfo, " DELETE FROM jsbantraban where NUMDOC = '" & txtCodigo.Text & "' AND TIPOMOV = 'DP' AND ORIGEN = 'PFC' AND NUMORG = '" & txtCodigo.Text & "' AND EJERCICIO = '" & jytsistema.WorkExercise & "' AND ID_EMP = '" & jytsistema.WorkID & "' ")
                EjecutarSTRSQL(myConn, lblInfo, " DELETE FROM jsbantracaj where NUMMOV = '" & txtCodigo.Text & "' AND ORIGEN = 'PFC' AND TIPOMOV = 'EN' AND EJERCICIO = '" & jytsistema.WorkExercise & "' AND ID_EMP = '" & jytsistema.WorkID & "' ")
                EjecutarSTRSQL(myConn, lblInfo, " delete from jsventracob where NUMMOV = '" & txtCodigo.Text & "' AND ORIGEN = 'PFC' AND TIPOMOV = 'NE' AND EJERCICIO = '" & jytsistema.WorkExercise & "' AND ID_EMP = '" & jytsistema.WorkID & "' ")
            ...
            End If
        Else
            MensajeCritico(lblInfo, "Eliminación de Notas de Entrega NO está permitida...")
        End If
    End Sub
    ...
    Private Sub Imprimir()
        ...
        'MensajeCritico(lblInfo, "Nota de Entrega YA fué impresa...")
        'Else
        ...
        'Else
        '    MensajeCritico(lblInfo, "Impresión de NOTA DE ENTREGA no permitida...")
        'End If
        'End If
