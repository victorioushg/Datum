...
Public Class jsVenRepParametrosPlus
    ...
    Private aAño() As Integer = {2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, _
    ...
    Private nTabla As String = "tbl" & NumeroAleatorio(1000000)
    ...
    Public Sub Cargar(ByVal TipoCarga As Integer, ByVal numReporte As Integer, ByVal nomReporte As String, _
        ...
        RellenaCombo(aTipoReporte, cmbTipoReporte)
    ...
    Private Sub IniciarGrupos()
        ...
        HabilitarObjetos(False, False, tabPageVentas, tabPageMercas, tabPageCompras)
        ...
        Select ReporteNumero
            Case ReporteVentas.cActivacionAsesor, ReporteVentas.cVentasAsesor, _
                ...
                HabilitarObjetos(True, False, tabPageVentas, tabPageMercas)
                C1DockingTab1.SelectedTab = tabPageVentas

                VisualizarObjetos(False, lblCanal, btnCanal, cmbCanal, lblTipoNegocio, btnTipoNegocio, cmbTipoNegocio, _
            ...
            Case ReporteMedicionGerencial.cComprasComparativasMesMes
                ...
                HabilitarObjetos(True, False, tabPageMercas, tabPageCompras)
    ...
    Private Sub VerCriterio_Año(ByVal ver As Boolean)
        VisualizarObjetos(ver, lblAño, cmbAño)
    End Sub
    ...
    Private Sub VerCriterio_TipoDocumento(ByVal ver As Boolean, Optional ByVal DocumentosTipo As Integer = 0)
        ...
        'VisualizarObjetos(ver, lblTipodocumento, btnTipoDocumento, cmbTipoDocumento, lblTipoDocumentoSeleccion)
    ...
    Private Sub VerCriterio_Cliente(ByVal ver As Boolean)
        VisualizarObjetos(ver, lblcliente, btnCliente, cmbCliente, lblClienteSeleccion)
    End Sub
    
    Private Sub VerCriterio_Almacen(ByVal ver As Boolean)
        VisualizarObjetos(ver, lblCriterioAlmacen, btnAlmacen, cmbAlmacen, lblAlmacenSeleccion)

    End Sub
    Private Sub VerCriterio_Mercancia(ByVal ver As Boolean)
        VisualizarObjetos(ver, lblMercancia, btnMercancia, cmbMercancias, lblMercanciaSeleccion)
    End Sub
    ...
    Private Sub IniciarConstantes()
        ...
        Select Case ReporteNumero
            ...
            Case ReporteMercancias.cExistenciasAUnaFecha
                ...
                txtConstanteVentas.Text = FormatoEntero(90)
                VerConstante_TipoReporte(True)
    ...
    Private Sub ValoresInicialesConstantes()
        ...
        If OrigenReporte(ReporteNumero) = " MER " Then
            RellenaCombo(aEstatusMercancias, cmbEstatus)
            RellenaCombo(aExistencias, cmbDescuentos, 2)
            lblDescuentos.Text = "Existencias"
        ElseIf OrigenReporte(ReporteNumero) = " VEN " Then
            RellenaCombo(aEstatusClientes, cmbEstatus)
        ...
        RellenaCombo(aTipoMercancia, cmbTipoMercancias)
    ...
    Private Sub VerConstante_VentasConstante(ByVal Ver As Boolean)
        VisualizarObjetos(Ver, lblConstanteVentas, txtConstanteVentas)
    End Sub
    Private Sub VerConstante_TipoReporte(ByVal Ver As Boolean)
        VisualizarObjetos(Ver, lblTipoReporte, cmbTipoReporte)
    End Sub
    Private Sub VerConstante_TipoMercancia(ByVal Ver As Boolean)
        VisualizarObjetos(Ver, lblTipoMercancia, cmbTipoMercancias)
    End Sub
    ...
    Private Sub btnTipoNegocio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTipoNegocio.Click
        If lblCanalSeleccion.Text.Trim = "" Then
            MensajeCritico(lblInfo, "Debe indicar uno ó varios canales de distribución ")
        Else
    ...
    Private Sub AbrirTabla(Titulo As String, strSQL As String, lblSeleccion As Label)
        ...
        f.Cargar(myConn, ds, Titulo, strSQL, _
            {"sel.entero", "codigo.cadena15", "descrip.cadena150"}, aNombres, aCampos, aAnchos, aAlineacion, aFormato)
    ...
    Private Sub btnAgregaConsulta_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregaConsulta.Click
        If cmbMisConsultas.Text.Trim <> "" Then
            ...
            If EjecutarSTRSQL_ScalarPLUS(myConn, " select count(*) from " _
                                         & " jsconencconsulta " _
                                         & " where " _
    ...
    Private Sub InsertarConsulta(MyConn As MySqlConnection, ConsultaNombre As String, ReporteNumero As Integer, Optional INSERTAR As Boolean = True)
        ...
        Dim aID_Objeto() As Object = {lblCanalSeleccion, lblTipoNegocioSeleccion, lblzonaSeleccion, lblRutaSeleccion, lblAsesorSeleccion, _
                                      lblCategoriaSeleccion, lblMarcasSeleccion, lblDivisionesSeleccion, lblJerarquiasSeleccion}

        Dim CodigoConsulta As String = ""

        If INSERTAR Then

            CodigoConsulta = AutoCodigoPlus(MyConn, "CONSULTA_ID", "jsconencconsulta", "", "", 10)
            EjecutarSTRSQL(MyConn, lblInfo, " INSERT INTO jsconencconsulta SET " _
        ...
        EjecutarSTRSQL_Scalar(MyConn, lblInfo, " DELETE FROM jsconrenconsulta " _
                              & " where " _
        ...
        For Each aElemen As Object In aID_Objeto
            If aElemen.text.trim() <> "" Then
                EjecutarSTRSQL(MyConn, lblInfo, " INSERT INTO jsconrenconsulta SET " _
                    & " CONSULTA_ID = '" & CodigoConsulta & "', " _
    ...
    Private Sub btnEliminaConsulta_Click(sender As System.Object, e As System.EventArgs) Handles btnEliminaConsulta.Click
        EjecutarSTRSQL(myConn, lblInfo, " DELETE FROM jsconencconsulta where " _
                       & " CONSULTA_ID = '" & cmbMisConsultas.SelectedValue & "' AND " _
                       & " ID_EMP = '" & jytsistema.WorkID & "' ")

        EjecutarSTRSQL(myConn, lblInfo, " DELETE FROM jsconrenconsulta where " _
                       & " CONSULTA_ID = '" & cmbMisConsultas.SelectedValue & "' AND " _
                       & " ID_EMP = '" & jytsistema.WorkID & "' ")
