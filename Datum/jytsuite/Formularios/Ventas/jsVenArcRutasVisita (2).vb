...
Public Class jsVenArcRutasVisita
    ...
    Private strSQL As String = "SELECT a.*, " _
            ...
            & " WHERE " _
            & " a.TIPO = '0' AND " _
            & " a.iD_EMP = '01' ORDER BY a.codven, a.dia "
    ...
    Private Function Validado() As Boolean
        If i_modo = movimiento.iAgregar AndAlso _
                CStr(EjecutarSTRSQL_Scalar(myConn, lblInfo, " select codrut from jsvenencrut " _
                                    & " where " _
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        'If CBool(Parametro(myConn, lblInfo, Gestion.iVentas, "VENCOTPA01")) Then
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        '            CBool(Parametro(myConn, lblInfo, Gestion.iVentas, "VENCOTPA07")) Then
        '        If CBool(Parametro(myConn, lblInfo, Gestion.iVentas, "VENCOTPA08")) Then
