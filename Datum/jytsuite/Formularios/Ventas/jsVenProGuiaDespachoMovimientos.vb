...
Public Class jsVenProGuiaDespachoMovimientos
    ...
    Private Sub jsVenProGuiaDespachoMovimientos_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ft = Nothing
    End Sub
        ...
        If Validado() Then
            ...
            For lvCont = 0 To lvPedidos.Items.Count - 1
                ...
                If lvPedidos.Items(lvCont).Checked Then
                    ...
                    Dim MontoFactura As Double = ft.DevuelveScalarDoble(MyConn, " select tot_fac from jsvenencfac where numfac = '" & lvPedidos.Items(lvCont).Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
