...
Public Class jsVenArcCanalTiponegocio
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = vbYes Then
            If dg1.RowCount > 0 Then
                MensajeCritico(lblInfo, "No es posible eliminar, pues posee Tipos de Negocio asociados...")
            Else
                Dim aCampos() As String = {"codigo", "id_emp"}
                Dim aString() As String = {dtG0.Rows(PosicionG0).Item("codigo"), jytsistema.WorkID}
                EliminarRegistros(myConn, lblInfo, ds, nTablaG0, "jsvenliscan", strSQLG0, aCampos, aString, PosicionG0)
            End If
        End If
    ...
    Private Sub btnEliminarS1_Click(sender As System.Object, e As System.EventArgs) Handles btnEliminarS1.Click
        ...
        If sRespuesta = vbYes Then
            ...
            EliminarRegistros(myConn, lblInfo, ds, nTablaG1, "jsvenlistip", strSQLG1, aCampos, aString, PosicionG1)
        End If
        AsignaTXTG0(PosicionG0, False)
    End Sub
End Class