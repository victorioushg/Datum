...
Public Class jsVenRepParametrosDos
    ...
    Private Sub PresentarReporte(ByVal NumeroReporte As Integer, ByVal NombreDelReporte As String, Optional ByVal CodigoCliente As String = "")
        ...
        Select Case NumeroReporte
            ...
            Case ReporteVentas.cVentasPorCliente, ReporteVentas.cVentasPorClientesPlus
                Dim vOrdenNombres() As String = {"Código Cliente"}
            ...
            Case ReporteVentas.cVentasPorClienteMesMes
                ...
                Dim vOrdenTipo() As String = {"S"}
                Dim vOrdenLongitud() As Integer = {15}
                Inicializar(ReporteNombre, True, True, False, False, vOrdenNombres, vOrdenCampos, vOrdenTipo, vOrdenLongitud, CodigoCliente)
            ...
            Case ReporteVentas.cChequesDevueltos, ReporteVentas.cChequesDevueltosMes
                Dim vOrdenNombres() As String = {"Código Cliente"}
                Dim vOrdenCampos() As String = {"codcli"}
                Dim vOrdenTipo() As String = {"S"}
                Dim vOrdenLongitud() As Integer = {15}
    ...
    Private Sub IniciarGrupos()
        ...
        Select Case ReporteNumero
            Case ReporteVentas.cVentasPorCliente, ReporteVentas.cRanking, _
                ReporteVentas.cBackorders, ReporteVentas.cVentasPorClientesPlus
    ...
    Private Sub IniciarCriterios()
        ...
        Select Case ReporteNumero
            ...
            Case ReporteVentas.cChequesDevueltos, ReporteVentas.cChequesDevueltosMes, _
            ...
            Case ReporteVentas.cComisionesPorJerarquia, ReporteVentas.cComisionesPorFacturaYJerarquia, _
                ReporteVentas.cComisionesPorDiasCobranza
                VerCriterio_Periodo(True, 0, TipoPeriodo.iMensual)
                VerCriterio_Asesor(True)
            Case Else
    ...
    Private Sub VerCriterio_Almacen(ByVal ver As Boolean)
        VisualizarObjetos(ver, lblAlmacen, txtAlmacenDesde, btnAlmacenDesde, _
    ...
    Private Sub IniciarConstantes()
        ...
        Select Case ReporteNumero
            ...
            Case ReporteVentas.cVentasPorCliente, ReporteVentas.cVentasPorClientesPlus
                verConstante_Resumen(True)
                VerConstante_ConstanteVentas(True)
            Case ReporteVentas.cVentasClienteDivision
                VerConstante_Estatus(True)
    ...
    Private Sub ValoresInicialesConstantes()
        ...
        txtConstanteVentas.Text = FormatoNumero(500)
        txtPrimeros.Text = FormatoEntero(30)
        rBtnConstanteKilos.Checked = True
    ...
    Private Sub VerConstante_ConstanteVentas(ByVal Ver As Boolean)
        VisualizarObjetos(Ver, lblConstanteVentas, txtConstanteVentas, rBtnConstanteKilos, rBtnConstanteMonetarios)
    End Sub
    Private Sub VerConstante_Primeros(ByVal Ver As Boolean)
        VisualizarObjetos(Ver, lblPrimeros, txtPrimeros)
    End Sub
        ...
        Select Case ReporteNumero
            ...
            Case ReporteVentas.cVentasPorClienteMesMes
                ...
                Select Case GruposCantidad(cmbMERAgrupadoPor.SelectedIndex.ToString & cmbCXCAgrupadorPor.SelectedIndex.ToString)
                    Case 0 ' 0 grupos
                        ...
                        'Case 1 '1 Grupo"
                        '    'oReporte = New rptVentasClientesDivision1G
                        'Case 2 '2 grupos
                        '    'oReporte = New rptVentasClientesDivision2G
                        'Case 3 '3 grupos
                        '    'oReporte = New rptVentasClientesDivision3G
                        'Case 4 '4 grupos
                        '    'oReporte = New rptVentasClientesDivision4G
                    Case Else
                        oReporte = New rptVentasClientesMesMes0G
                End Select
                str = SeleccionVENVentasClientesMes(txtOrdenDesde.Text, txtOrdenHasta.Text, txtCanalDesde.Text, txtCanalHasta.Text, _
                                                    txtTipoNegocioDesde.Text, txtTipoNegocioHasta.Text, txtZonaDesde.Text, txtZonaHasta.Text, _
                                                    txtRutaDesde.Text, txtRutaHasta.Text, txtAsesorDesde.Text, txtAsesorHasta.Text, _
            ...
            Case ReporteVentas.cVentasClienteDivision
                ...
                Select Case GruposCantidad(cmbMERAgrupadoPor.SelectedIndex.ToString & cmbCXCAgrupadorPor.SelectedIndex.ToString)
                    ...
                    Case Else
                        oReporte = New rptVentasClientesDivision0G
                End Select
                str = SeleccionVENVentasPorDivision(CDate(txtPeriodoDesde.Text), CDate(txtPeriodoHasta.Text), txtClienteDesde.Text, txtClienteHasta.Text, _
                                                     txtCanalDesde.Text, txtCanalHasta.Text, txtTipoNegocioDesde.Text, txtTipoNegocioHasta.Text, txtZonaDesde.Text, _
                                                     txtZonaHasta.Text, txtRutaDesde.Text, txtRutaHasta.Text, txtAsesorDesde.Text, txtAsesorHasta.Text, _
            ...
            Case ReporteVentas.cChequesDevueltos
                ...
                Select Case GruposCantidad(cmbMERAgrupadoPor.SelectedIndex.ToString & cmbCXCAgrupadorPor.SelectedIndex.ToString)
                    ...
                    Case 1 '1 Grupo"
                        oReporte = New rptVentasChequesDevueltos1G
                    Case 2 '2 grupos
                        oReporte = New rptVentasChequesDevueltos2G
                    Case 3 '3 grupos
                        oReporte = New rptVentasChequesDevueltos3G
                    Case Else
                        oReporte = New rptVentasChequesDevueltos0G
                End Select

                str = SeleccionVENChequesDevueltos(txtOrdenDesde.Text, txtOrdenHasta.Text, vOrdenCampos(cmbOrdenadoPor.SelectedIndex), cmbOrdenDesde.SelectedIndex, _
                                            txtCanalDesde.Text, txtCanalHasta.Text, txtTipoNegocioDesde.Text, txtTipoNegocioHasta.Text, txtZonaDesde.Text, txtZonaHasta.Text, txtRutaDesde.Text, txtRutaHasta.Text, txtAsesorDesde.Text, txtAsesorHasta.Text, txtPais.Text, txtEstado.Text, txtMunicipio.Text, txtParroquia.Text, txtCiudad.Text, txtBarrio.Text, CDate(txtPeriodoDesde.Text), CDate(txtPeriodoHasta.Text), cmbTipo.SelectedIndex, cmbEstatus.SelectedIndex, chkConsResumen.Checked)
            ...
            Case ReporteVentas.cVentasPorCliente
                nTabla = "dtVentasVentasYActivacion"
                Select Case GruposCantidad(cmbMERAgrupadoPor.SelectedIndex.ToString & cmbCXCAgrupadorPor.SelectedIndex.ToString)
                    Case 0 ' 0 grupos
                        oReporte = New rptVentasVentasYActivacion0G
                    Case 1 '1 Grupo"
                        oReporte = New rptVentasVentasYActivacion1G
                    Case 2 '2 grupos
                        oReporte = New rptVentasVentasYActivacion2G
                    Case 3 '3 grupos
                        oReporte = New rptVentasVentasYActivacion3G
                    Case 4 '4 grupos
                        oReporte = New rptVentasVentasYActivacion4G
                    Case Else
                        oReporte = New rptVentasVentasYActivacion0G
                End Select

                str = SeleccionVENVentasClientesAct(txtOrdenDesde.Text, txtOrdenHasta.Text, vOrdenCampos(cmbOrdenadoPor.SelectedIndex), _
                                                    txtTipoJerarquia.Text, txtCodjer1.Text, txtCodjer2.Text, txtCodjer3.Text, txtCodjer4.Text, txtCodjer5.Text, txtCodjer6.Text, _
                                                    txtCategoriaDesde.Text, txtCategoriaHasta.Text, txtMarcaDesde.Text, txtMarcaHasta.Text, _
                                                    txtDivisionDesde.Text, txtDivisionHasta.Text, txtCanalDesde.Text, txtCanalHasta.Text, _
                                                    txtTipoNegocioDesde.Text, txtTipoNegocioHasta.Text, txtZonaDesde.Text, txtZonaHasta.Text, _
                                                    txtRutaDesde.Text, txtRutaHasta.Text, txtAsesorDesde.Text, txtAsesorHasta.Text, _
                                                    txtPais.Text, txtEstado.Text, txtMunicipio.Text, txtParroquia.Text, txtCiudad.Text, txtBarrio.Text, _
                                                    CDate(txtPeriodoDesde.Text), CDate(txtPeriodoHasta.Text), txtAlmacenDesde.Text, txtAlmacenHasta.Text, _
                                                    , txtMercanciaDesde.Text, txtMercanciaHasta.Text, chkConsResumen.Checked, , CDbl(txtConstanteVentas.Text), _
                                                    rBtnConstanteMonetarios.Checked)
            Case ReporteVentas.cVentasPorClientesPlus
                ...
                Select Case GruposCantidad(cmbMERAgrupadoPor.SelectedIndex.ToString & cmbCXCAgrupadorPor.SelectedIndex.ToString)
                    ...
                    Case 1 '1 Grupo"
                        oReporte = New rptVentasVentasYActivacionPlus1G
                    Case 2 '2 gruposaaa                                                                     
                        oReporte = New rptVentasVentasYActivacionPlus2G
                    Case 3 '3 grupos
                        oReporte = New rptVentasVentasYActivacionPlus3G
                    Case 4 '4 grupos
                        oReporte = New rptVentasVentasYActivacionPlus4G
                    Case Else
                        oReporte = New rptVentasVentasYActivacionPlus0G
                End Select
    ...
    Private Function PresentaReporte(ByVal oReporte As CrystalDecisions.CrystalReports.Engine.ReportClass, _
        ...
        Select Case ReporteNumero
            ...
            Case ReporteVentas.cPedidosSinFacturar, ReporteVentas.cChequesDevueltos, ReporteVentas.cChequesDevueltosMes, _
                ReporteVentas.cVentasPorCliente, ReporteVentas.cVentasClienteDivision, ReporteVentas.cCobranzaActual, _
                ReporteVentas.cCobranzaAnterior, ReporteVentas.cRanking, ReporteVentas.cBackorders, ReporteVentas.cVentasPorClientesPlus, _
                ...
                If ReporteNumero = ReporteVentas.cBackorders Or ReporteNumero = ReporteVentas.cVentasPorCliente _
                    Or ReporteNumero = ReporteVentas.cVentasPorClientesPlus _
                ...
                If ReporteNumero = ReporteVentas.cVentasClienteDivision Then
                    oReporte.SetParameterValue("Division1", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00001' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                    oReporte.SetParameterValue("Division2", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00002' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                    oReporte.SetParameterValue("Division3", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00003' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                    oReporte.SetParameterValue("Division4", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00004' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                    oReporte.SetParameterValue("Division5", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00005' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                    oReporte.SetParameterValue("Division6", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00006' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                    oReporte.SetParameterValue("Division7", EjecutarSTRSQL_Scalar(myConn, lblInfo, "select descrip from jsmercatdiv where division = '00007' and id_emp = '" & jytsistema.WorkID & "' ").ToString)
                End If
    ...
    Private Function LineaConstantes() As String
        ...
        If lblLapso.Visible Then LineaConstantes += " Lapsos: 1. " + txtDesde1.Text + "-" + txtHasta1.Text + _
                                                    ...
                                                    " 4. " + txtDesde4.Text
        If lblConstanteVentas.Visible Then LineaConstantes += " - Ventas mayores a " & txtConstanteVentas.Text & " " & IIf(rBtnConstanteKilos.Checked, "KGR", " :Moneda de curso")
