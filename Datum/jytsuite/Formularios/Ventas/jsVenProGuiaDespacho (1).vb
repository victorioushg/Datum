...
Public Class jsVenProGuiaDespacho
    ...
    Private Const lRegion As String = "RibbonButton219"
    Private Const nTablaRenglones As String = "tblRenglones_GuiaDespacho"

    Private strSQL As String = "select * from jsvenencgui where ID_EMP = '" _
    ...
    Private Sub AsignarTooltips()
        'Menu Barra 
        C1SuperTooltip1.SetToolTip(btnAgregar, "<B>Agregar</B> nueva Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnEditar, "<B>Editar o mofificar</B> Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnEliminar, "<B>Eliminar</B> Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnBuscar, "<B>Buscar</B> Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnPrimero, "ir a la <B>primer</B> Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnSiguiente, "ir a Guia Despacho <B>siguiente</B>")
        C1SuperTooltip1.SetToolTip(btnAnterior, "ir a Guia Despacho <B>anterior</B>")
        C1SuperTooltip1.SetToolTip(btnUltimo, "ir a la <B>último Guia Despacho</B>")

        C1SuperTooltip1.SetToolTip(btnSalir, "<B>Cerrar</B> esta ventana")

        'Menu barra renglón
        C1SuperTooltip1.SetToolTip(btnAgregarMovimiento, "<B>Agregar</B> renglón en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnEditarMovimiento, "<B>Editar</B> renglón en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnEliminarMovimiento, "<B>Eliminar</B> renglón en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnBuscarMovimiento, "<B>Buscar</B> un renglón en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnPrimerMovimiento, "ir al <B>primer</B> renglón en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnAnteriorMovimiento, "ir al <B>anterior</B> renglón en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnSiguienteMovimiento, "ir al renglón <B>siguiente </B> en Guia Despacho")
        C1SuperTooltip1.SetToolTip(btnUltimoMovimiento, "ir al <B>último</B> renglón de la Guia Despacho")
    ...
    Private Sub AsignarMovimientos(ByVal CodigoGuia As String)
        ...
        strSQLMov = "select a.*, elt(b.condpag+1,'CR','CO') as condpag  " _
                        & " from jsvenrengui a " _
                        & " left join jsvenencfac b on (a.codigofac = b.numfac and a.id_emp = b.id_emp)" _
        ...
        Dim aNombres() As String = {"Número Factura", "Nombre Cliente", "Condición Pago", "Total Factura", "Peso Factura (Kgs)", ""}
    ...
    Private Sub AgregaYCancela()
        ...
        EjecutarSTRSQL(myConn, lblInfo, " delete from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub GuardarTXT()
        ...
        If i_modo = movimiento.iAgregar Then
            ...
            Codigo = Contador(myConn, lblInfo, Gestion.iVentas, "VENNUMGUI", "15")

            EjecutarSTRSQL(myConn, lblInfo, " update jsvenrengui set codigoguia = '" & Codigo & "' where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub ActualizarMovimientos(ByVal Codigo As String)
        ...
        EjecutarSTRSQL(myConn, lblInfo, "UPDATE jsvenencfac SET " _
                & " RELGUIA = '' WHERE RELGUIA = '" & Codigo & "' and " _
                & " EJERCICIO = '" & jytsistema.WorkExercise & "' and " _
                & " ID_EMP = '" & jytsistema.WorkID & "'")

        For iCont = 0 To dtRenglones.Rows.Count - 1
            With dtRenglones.Rows(iCont)
                EjecutarSTRSQL(myConn, lblInfo, " update jsvenencfac set relguia = '" & Codigo & "' where numfac = '" & .Item("codigofac").ToString & "' and id_emp = '" & jytsistema.WorkID & "' ")
            End With
        Next
    End Sub
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = MsgBoxResult.Yes Then
            ...
            EjecutarSTRSQL(myConn, lblInfo, " delete from jsvenencgui where " _
                & " codigoguia = '" & txtCodigo.Text & "' AND " _
                & " ID_EMP = '" & jytsistema.WorkID & "'")

            EjecutarSTRSQL(myConn, lblInfo, " delete from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
            EjecutarSTRSQL(myConn, lblInfo, " update jsvenencfac set relguia = '' where relguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub CalculaTotales()
        ...
        txtTotal.Text = FormatoNumero(CDbl(EjecutarSTRSQL_Scalar(myConn, lblInfo, " select sum(totalfac) from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' group by codigoguia ")))
        tslblPesoT.Text = FormatoCantidad(CDbl(EjecutarSTRSQL_Scalar(myConn, lblInfo, " select sum(kilosfac) from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' group by codigoguia ")))
        ...
        If nPosicionRenglon >= 0 Then
            ...
            If sRespuesta = MsgBoxResult.Yes Then
                With dtRenglones.Rows(nPosicionRenglon)
                    ...
                    EjecutarSTRSQL(myConn, lblInfo, " update jsvenencfac set relguia = '' where numfac = '" & .Item("codigofac") & "' and id_emp = '" & jytsistema.WorkID & "' ")

                    nPosicionRenglon = EliminarRegistros(myConn, lblInfo, ds, nTablaRenglones, "jsvenrengui", strSQLMov, aCamposDel, aStringsDel, _
    ...
    Private Sub btnRelacion_Click(sender As System.Object, e As System.EventArgs) Handles btnRelacion.Click
        ...
        f.Cargar(TipoCargaFormulario.iShowDialog, ReporteVentas.cFacturasGuiaDespacho, "Relación Facturas Guía Despacho", , txtCodigo.Text)
        f.Dispose()
        f = Nothing
    End Sub

    Private Sub btnMercancias_Click(sender As System.Object, e As System.EventArgs) Handles btnMercancias.Click
        Dim f As New jsVenRepParametros
        f.Cargar(TipoCargaFormulario.iShowDialog, ReporteVentas.cMercanciasGuiaDespacho, "Relación de mercancías Guía Despacho", , txtCodigo.Text)
        f.Dispose()
        f = Nothing
    End Sub
    ...
    Private Sub btnFacturas_Click(sender As System.Object, e As System.EventArgs) Handles btnFacturas.Click
        ...
        If sRespuesta = MsgBoxResult.Yes Then
            If dtRenglones.Rows.Count > 0 Then
                ...
                Else
                    If CBool(ParametroPlus(MyConn, Gestion.iVentas, "VENPARAM08")) Then
                        Dim ff As New jsVenProGuiaDespachoImpresion
                        ff.Cargar(myConn, txtCodigo.Text, dtRenglones)
                        ff.Dispose()
                        ff = Nothing
                    Else
                        ...
                        Next
                        MsgBox(dtRenglones.Rows.Count.ToString & " Facturas de GUIA N° " & txtCodigo.Text & " han sido enviadas a la impresora fiscal", MsgBoxStyle.Information)
    ...
    Private Sub Imprimir(ByVal CodigoFactura)
        ...
        If Not DocumentoImpreso(myConn, lblInfo, "jsvenencfac", "numfac", CodigoFactura) Then
            ...
            MensajeInformativo(lblInfo, "Imprimiendo Factura N° : " & CodigoFactura)
            EsperateUnPoquito(myConn)
            ...
            If dtFactura.Rows.Count > 0 Then
                For kCont As Integer = 0 To dtFactura.Rows.Count - 1
                    With dtFactura.Rows(kCont)
                        ...
                        Dim nNombreCliente As Object = EjecutarSTRSQL_Scalar(myConn, lblInfo, " select nombre from jsvencatcli where codcli = '" & .Item("codcli") & "' and id_emp = '" & jytsistema.WorkID & "' ")
                        Dim nNombreAsesor As Object = EjecutarSTRSQL_Scalar(myConn, lblInfo, " SELECT CONCAT(apellidos, ' ', nombres) nombre FROM jsvencatven WHERE codven = '" & .Item("codven") & "' AND tipo = 0 AND id_emp = '" & jytsistema.WorkID & "'  ")
                        ...
                        Select Case nTipoImpreFiscal
                            ...
                            Case 2, 5, 6  'IMPRESORA FISCAL TIPO ACLAS/BIXOLON
                                ...
                                ImprimirFacturaFiscalPP1F3(myConn, lblInfo, CodigoFactura, NumeroSERIALImpresoraFISCAL(myConn, lblInfo, jytsistema.WorkBox), _
                                    NombreCliente, .Item("codcli"), EjecutarSTRSQL_Scalar(myConn, lblInfo, "Select RIF from jsvencatcli where codcli = '" & .Item("codcli") & "' and id_emp = '" & jytsistema.WorkID & "'"), _
                                    EjecutarSTRSQL_Scalar(myConn, lblInfo, "Select DIRFISCAL from jsvencatcli where codcli = '" & .Item("codcli") & "' and id_emp = '" & jytsistema.WorkID & "'"), _
                            ...
                            Case 4 'IMPRESORA FISCAL TIPO EPSON/PNP
                                ImprimirFacturaFiscalPnP(myConn, lblInfo, CodigoFactura, NombreCliente, .Item("codcli"), _
                                    EjecutarSTRSQL_Scalar(myConn, lblInfo, "Select RIF from jsvencatcli where codcli = '" & .Item("codcli") & "' and id_emp = '" & jytsistema.WorkID & "'"), _
                                    EjecutarSTRSQL_Scalar(myConn, lblInfo, "Select DIRFISCAL from jsvencatcli where codcli = '" & .Item("codcli") & "' and id_emp = '" & jytsistema.WorkID & "'"), _
        ...
        Else
            MensajeCritico(lblInfo, "FACTURA N° " & CodigoFactura & " NO IMPRESA...")
