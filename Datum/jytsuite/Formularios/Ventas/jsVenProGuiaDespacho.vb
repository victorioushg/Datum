...
Public Class jsVenProGuiaDespacho
    ...
    Private Sub jsVenProGuiaDespacho_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ft = Nothing
    End Sub
    ...
    Private Sub AgregaYCancela()
        ...
        ft.Ejecutar_strSQL(myconn, " delete from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub GuardarTXT()
        ...
        If i_modo = movimiento.iAgregar Then
            ...
            ft.Ejecutar_strSQL(myconn, " update jsvenrengui set codigoguia = '" & Codigo & "' where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub ActualizarMovimientos(ByVal Codigo As String)
        ...
        For iCont = 0 To dtRenglones.Rows.Count - 1
            With dtRenglones.Rows(iCont)
                ft.Ejecutar_strSQL(myconn, " update jsvenencfac set relguia = '" & Codigo & "' where numfac = '" & .Item("codigofac").ToString & "' and id_emp = '" & jytsistema.WorkID & "' ")
            End With
        Next
    End Sub
    ...
    Private Sub btnEditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEditar.Click
        Dim aCamposAdicionales() As String = {"codigoguia|'" & txtCodigo.Text & "'"}
        If DocumentoBloqueado(myConn, "jsvenencgui", aCamposAdicionales) Then
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        Else
            ...
            If sRespuesta = MsgBoxResult.Yes Then
                ...
                ft.Ejecutar_strSQL(myConn, " delete from jsvenencgui where " _
                    & " codigoguia = '" & txtCodigo.Text & "' AND " _
                    & " ID_EMP = '" & jytsistema.WorkID & "'")

                ft.Ejecutar_strSQL(myConn, " delete from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
                ft.Ejecutar_strSQL(myConn, " update jsvenencfac set relguia = '' where relguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub CalculaTotales()
        ...
        txtTotal.Text = ft.FormatoNumero(ft.DevuelveScalarDoble(myConn, " select sum(totalfac) from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' group by codigoguia "))
        tslblPesoT.Text = ft.FormatoCantidad(ft.DevuelveScalarDoble(myConn, " select sum(kilosfac) from jsvenrengui where codigoguia = '" & txtCodigo.Text & "' and id_emp = '" & jytsistema.WorkID & "' group by codigoguia "))
        ...
        If nPosicionRenglon >= 0 Then
            ...
            If sRespuesta = MsgBoxResult.Yes Then
                With dtRenglones.Rows(nPosicionRenglon)
                    ...
                    ft.Ejecutar_strSQL(myconn, " update jsvenencfac set relguia = '' where numfac = '" & .Item("codigofac") & "' and id_emp = '" & jytsistema.WorkID & "' ")
    ...
    Private Sub txtTransporte_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtTransporte.TextChanged
        ...
        txtCapacidadTransporte.Text = ft.muestraCampoCantidad(ft.DevuelveScalarDoble(myConn, " select capacidad from jsconctatra where codtra = '" & txtTransporte.Text _
                                                         & "' and id_emp = '" & jytsistema.WorkID & "' "))
        txtChoferTransporte.Text = ft.muestraCampoTexto(ft.DevuelveScalarCadena(myConn, " select chofer from jsconctatra where codtra = '" & txtTransporte.Text _
                                                         & "' and id_emp = '" & jytsistema.WorkID & "' "))
    ...
    Private Sub btnFacturas_Click(sender As System.Object, e As System.EventArgs) Handles btnFacturas.Click
        Dim sRespuesta As Microsoft.VisualBasic.MsgBoxResult
        sRespuesta = MsgBox(" ¿ Está seguro que desea imprimir facturas de la guía de despacho N° " & txtCodigo.Text & " ?", MsgBoxStyle.YesNo, sModulo & " Impresión Guía Despacho ... ")
