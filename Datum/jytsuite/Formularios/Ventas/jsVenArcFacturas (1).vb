...
Public Class jsVenArcFacturas
    ...
    Private Sub AsignarMovimientos(ByVal NumeroFactura As String)
        ...
        Dim aAnchos() As Long = {90, 350, 30, 60, 45, 70, 50, 50, 50, 100, 70, 100}
    ...
    Private Sub IncluirFleteAutomatico(Codigocliente As String, montoFlete As Double)
        ...
        If CBool(ParametroPlus(MyConn, Gestion.iVentas, "VENFACPA24")) Then
            ...
            Dim numRenglon As String = AutoCodigoPlus(myConn, "renglon", "jsvenrenfac", "numfac", txtCodigo.Text, 5)
    ...
    Private Sub CalculaTotales()
        ...
        'If CBool(ParametroPlus(MyConn, Gestion.iVentas, "VENFACPA12")) Then AjustarExistencias(myConn, txtCodigo.Text, lblInfo, txtAlmacen.Text, "NUMFAC", "jsvenrenfac", "FAC")
    ...
    Private Sub grpDisponibilidad_Enter(sender As System.Object, e As System.EventArgs) Handles grpDisponibilidad.Enter
