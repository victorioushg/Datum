...
Public Class jsGenIVAAlbaran
    Private Const sModulo As String = "DESCUENTOS "
    Private Const nTabla As String = "tblDescuentos"
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"codcaj", "descrip", "almacen", "impre_fiscal", ""}
        Dim aNombres() As String = {"Código", "Nombre", "Almacén", "Tipo Impresora", ""}
        Dim aAnchos() As Long = {70, 200, 60, 90, 10}
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If sRespuesta = vbYes Then
            ...
            EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsvencatcaj", strSQL, aCampos, aString, Posicion)
        End If
    ...
    Private Sub dg_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg.CellDoubleClick
        Posicion = Me.BindingContext(ds, nTabla).Position
        If dt.Rows.Count > 0 Then
            Seleccionado = dt.Rows(Posicion).Item("codcat").ToString
            InsertarAuditoria(myConn, MovAud.iSeleccionar, Me.Text, "")
        End If
        Me.Close()
    End Sub
