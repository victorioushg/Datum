...
Imports fTransport
Public Class jsProArcSeguimientoProduccion
    ...
    Private Sub jsProArcOrdenDeProduccion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            DesactivarMarco0()
            tbcSeguimiento.SelectedTab = tabPageFormulacion
    ...
    Private Sub ActivarMarco0()
        ...
        ft.habilitarObjetos(True, True, txtDescripProduccion, btnEmision, cmbEstatus)
    ...
    Private Sub DesactivarMarco0()
        ...
        ft.habilitarObjetos(False, True, txtCodigo, btnEmision, txtDescripProduccion, cmbEstatus)
    ...
    Private Sub GuardarTXT()
        ...
        'InsertEditPRODUCCIONEncabezadoOrdenProduccion(myConn, lblInfo, Inserta, Codigo, txtDescripProduccion.Text, cmbEstatus.SelectedIndex, "")
    ...
    'Private Sub btnEstimada_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub tbcRenglones_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles tbcSeguimiento.SelectedIndexChanged
        Select Case tbcSeguimiento.SelectedIndex
            Case 0 'FORMULA
                AsignarMovimientos(txtCodigo.Text)
            Case 1 'RESIDUALES
