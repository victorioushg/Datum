...
Public Class jsControlArcEmpresas
    ...
    Private Const nTablaMonedas As String = "monedas"
    ...
    Private Sub IniciarEmpresa(ByVal Inicio As Boolean)
        ...
        ft.iniciarTextoObjetos(Transportables.tipoDato.Cadena, txtCodigo, txtNombre, txtDirFiscal, txtDirDepsacho, txtCiudad, txtEstado, txtCodGeo,
                            txtZIP, txtTelefono1, txtTelefono2, txtFAX, txtCorreoElectronico, txtActividad, txtRIF,
                            txtNIT, txtCIIU, txtCILetra, txtCINumero, txtPasaporte, txtCILetraRep, txtCIRep, txtRIFRep,
                            txtNITRep, txtNombreRep, txtDirFiscalRep, txtCiudadRep, txtEstadoRep, txtTelefonoRep,
                            txtFaxRep, txtEmailRep, txtCILetraGer, txtCIGer, txtNombreGer,
        ...
        cmbMonedas.SelectedValue = Nothing
        cmbMonedas.SelectedValue = Nothing
    ...
    Private Sub ActivarMarco0()
        ...
        ft.habilitarObjetos(True, True, txtNombre, txtDirFiscal, txtDirDepsacho, txtCiudad, txtEstado, txtCodGeo,
                            txtZIP, txtTelefono1, txtTelefono2, txtFAX, txtCorreoElectronico, txtActividad, txtRIF,
                            txtNIT, txtCIIU, cmbTipoPersona, cmbTipoSociedad, txtCILetra, txtCINumero, txtPasaporte,
                            txtCILetraRep, txtCIRep, txtRIFRep, txtNITRep, txtNombreRep, txtDirFiscalRep, txtCiudadRep,
                            txtEstadoRep, txtTelefonoRep, txtFaxRep, txtEmailRep, txtCILetraGer, txtCIGer, txtNombreGer,
                            txtDirFiscalGer, txtCiudadGer, txtEdoGer, txtTelefonoGer, txtMovilGer, txtemailGer, btnLogo,
                            cmbMonedas, cmbCambio)
    ...
    Private Sub DesactivarMarco0()
        ...
        ft.habilitarObjetos(False, True, txtCodigo, txtNombre, txtDirFiscal, txtDirDepsacho, txtCiudad, txtEstado, txtCodGeo,
                            txtZIP, txtTelefono1, txtTelefono2, txtFAX, txtCorreoElectronico, txtActividad, txtRIF,
                            txtNIT, txtCIIU, cmbTipoPersona, cmbTipoSociedad, txtCILetra, txtCINumero, txtPasaporte,
                            txtInicio, btnInicio, txtCierre, btnCierre,
                            txtCILetraRep, txtCIRep, txtRIFRep, txtNITRep, txtNombreRep, txtDirFiscalRep, txtCiudadRep,
                            txtEstadoRep, txtTelefonoRep, txtFaxRep, txtEmailRep, txtCILetraGer, txtCIGer, txtNombreGer,
                            txtDirFiscalGer, txtCiudadGer, txtEdoGer, txtTelefonoGer, txtMovilGer, txtemailGer, btnLogo,
                            cmbCambio, cmbMonedas)
    ...
    Private Sub GuardarTXT()
        ...
        InsertEditCONTROLEmpresa(myConn, lblInfo, Inserta, txtCodigo.Text, txtNombre.Text, txtDirFiscal.Text, txtDirDepsacho.Text, txtCiudad.Text,
            txtEstado.Text, txtCodGeo.Text, txtZIP.Text, txtTelefono1.Text, txtTelefono2.Text, txtFAX.Text,
            txtCorreoElectronico.Text, txtActividad.Text, txtRIF.Text, txtNIT.Text, txtCIIU.Text,
            cmbTipoPersona.SelectedIndex, CDate(txtInicio.Text), CDate(txtCierre.Text), cmbTipoSociedad.SelectedIndex,
            "1", txtCILetra.Text, txtCINumero.Text, txtPasaporte.Text, "0", "1", "0", "0",
            txtRIFRep.Text, txtNITRep.Text, txtCILetraRep.Text, txtCIRep.Text, txtNombreRep.Text,
