...
Public Class jsControlProVerificaBD
    ...
    Private Sub ActualizarBancos()
        ...
        Dim aIndices() As String = {"jsbancatban|PRIMARY|`codban`, `id_emp`",
                                    ...
                                    "jsbantraban|PRIMARY|`codban`, `fechamov`,`numdoc`,`tipomov`, `origen`,`numorg`,`prov_cli`,`ejercicio`,`id_emp`",
                                    "jsbantraban|SECONDARY|`BLOCK_DATE`,`ID_EMP`",
                                    "jsbantracaj|PRIMARY|`caja`,`renglon`,`fecha`, `origen`,`tipomov`,`nummov`, `aceptado`, `ejercicio`,`id_emp`",
