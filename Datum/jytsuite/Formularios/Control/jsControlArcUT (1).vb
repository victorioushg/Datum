...
Public Class jsControlArcUT
    Private Const sModulo As String = "Unidades Tributarias"
    Private Const lRegion As String = "RibbonButton203"
    Private Const nTabla As String = "tblUT"

    Private myConn As New MySqlConnection
    Private ds As New DataSet
    Private dt As New DataTable

    Private strSQL As String = " SELECT fecha, monto FROM jsconctaunt WHERE id_emp = '" & jytsistema.WorkID & "' order by fecha desc "
    ...
    End Sub
    Private Sub jsControlArcUT_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        dt = Nothing
        ds = Nothing
    End Sub

    Private Sub jsControlArcUT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"fecha", "monto"}
        Dim aNombres() As String = {" Fecha ", "Monto Unidad Tributaria"}
        Dim aAnchos() As Long = {100, 120}
        Dim aAlineacion() As Integer = {AlineacionDataGrid.Centro, AlineacionDataGrid.Derecha}
        Dim aFormatos() As String = {sFormatoFechaMedia, sFormatoNumero}
        IniciarTabla(dg, dt, aCampos, aNombres, aAnchos, aAlineacion, aFormatos)
    End Sub

    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Dim f As New jsControlArcUTMovimientos
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If NivelUsuario(myConn, lblInfo, jytsistema.sUsuario) Then
            ...
            If sRespuesta = vbYes Then
                ...
                Dim aCampos() As String = {"fecha"}
                With dt.Rows(Posicion)
                    Dim aString() As String = {FormatoFechaMySQL(CDate(.Item("fecha").ToString))}
                    EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsconctaunt", strSQL, aCampos, aString, Posicion)
                End With
    ...
    Private Sub btnSeleccionar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSeleccionar.Click
        ...
        If dt.Rows.Count > 0 Then
            Seleccionado = dt.Rows(Posicion).Item("fecha").ToString
