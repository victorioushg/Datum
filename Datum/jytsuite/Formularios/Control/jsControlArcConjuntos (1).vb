...
Public Class jsControlArcConjuntos
    Private Const sModulo As String = "Conjuntos de Datos"
    Private Const lRegion As String = ""
    Private Const nTabla As String = "tblConjuntos"

    Private myConn As New MySqlConnection
    Private ds As New DataSet
    Private dt As New DataTable

    Private strSQL As String = " select * from jsconcojcat where id_emp = '" & jytsistema.WorkID & "' order by codigo "
    ...
    Public Sub Cargar(ByVal Mycon As MySqlConnection, ByVal TipoCarga As Integer)
        ...
        If dt.Rows.Count = 0 Then
            EjecutarSTRSQL(myConn, lblInfo, " insert into jsconcojcat values('00001','Trabajadores', '',''," & Gestion.iRecursosHumanos & ", '" & jytsistema.WorkID & "') ")
            EjecutarSTRSQL(myConn, lblInfo, " insert into jsconcojtab values('00001', 'a','jsnomcattra', 0, ''," & Gestion.iRecursosHumanos & ",'" & jytsistema.WorkID & "' ) ")
            ds = DataSetRequery(ds, strSQL, myConn, nTabla, lblInfo)
            dt = ds.Tables(nTabla)
        End If
        Posicion = 0
    ...
    End Sub
    Private Sub jsControlArcConjuntos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        dt = Nothing
        ds = Nothing
    End Sub

    Private Sub jsControlArcConjuntos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aNombres() As String = {"Código", "Descripción"}
        Dim aAnchos() As Long = {70, 410}
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Dim f As New jsControlArcConjuntosMovimientos
