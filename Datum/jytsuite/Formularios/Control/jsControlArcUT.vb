...
Public Class jsControlArcUT
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Integer = {100, 120}
        ...
        If NivelUsuario(myConn, lblInfo, jytsistema.sUsuario) Then
            ...
            If ft.PreguntaEliminarRegistro() = Windows.Forms.DialogResult.Yes Then
                ...
                With dt.Rows(Posicion)
                    Dim aString() As String = {ft.FormatoFechaMySQL(CDate(.Item("fecha").ToString))}
                    Posicion = EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsconctaunt", strSQL, aCampos, aString, Posicion)
                End With
