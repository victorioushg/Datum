...
Public Class jsControlArcCondicionesPagoCobros
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Integer = {80, 300, 100}
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If nReg > 0 Then
            ft.MensajeCritico("(" & nReg & ") FORMA DE PAGO NO ELIMINABLE...")
        Else
            ...
            If ft.PreguntaEliminarRegistro() = Windows.Forms.DialogResult.Yes Then
                ...
                Posicion = EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsconctafor", strSQL, aCampos, aString, Posicion)
            End If
