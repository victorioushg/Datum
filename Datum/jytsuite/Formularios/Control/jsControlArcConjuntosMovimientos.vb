...
Public Class jsControlArcConjuntosMovimientos
    ...
    Private Sub IniciarTXT()
        txtCodigo.Text = ft.autoCodigo(MyConn, "codigo", "jsconcojcat", "id_emp", jytsistema.WorkID, 5)
        txtNombre.Text = ""
    ...
    Private Sub AsignarTXT(ByVal nPosicion As Integer)
        With dtLocal.Rows(nPosicion)
            ...
            ft.RellenaCombo(aGestion, cmbGestion, .Item("Gestion") - 1)
    ...
    Private Sub IniciarMovimiento(ByVal Codigo As String)
        ...
        Dim aAnc() As Integer = {40, 150, 100, 150}
    ...
    Private Sub txtCodigo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCodigo.GotFocus
        ft.mensajeEtiqueta(lblInfo, "Indique el código de conjunto ...", Transportables.TipoMensaje.iInfo)
    End Sub
    Private Sub txtNombre_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNombre.GotFocus
        ft.mensajeEtiqueta(lblInfo, "Indique el descripción de conjunto ...", Transportables.TipoMensaje.iInfo)
