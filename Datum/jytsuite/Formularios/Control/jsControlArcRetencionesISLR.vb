...
Public Class jsControlArcRetencionesISLR
    ...
    Public Sub Cargar(ByVal Mycon As MySqlConnection, ByVal TipoCarga As Integer)
        ...
        If TipoCarga = 0 Then
            If dg.RowCount = dt.Rows.Count Then Me.Show()
        Else
            Me.ShowDialog()
        End If
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Integer = {50, 440, 60, 70, 70, 120, 75, 65}
        ...
        For fCont = 0 To dt.Rows.Count - 1
            With dt.Rows(fCont)
                If .Item("tipo") = 0 Then
                    ...
                    ft.Ejecutar_strSQL(myconn, " update jscontabret set pagomin = " & PagoMinimo & ", menos = " & Sustraendo & " where codret = '" & .Item("codret") & "' and id_emp = '" & jytsistema.WorkID & "' ")
