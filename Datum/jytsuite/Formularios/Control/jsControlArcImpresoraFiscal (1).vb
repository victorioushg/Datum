...
Public Class jsControlArcImpresoraFiscal
    Private Const sModulo As String = "Tipos de impresión para facturación y puntos deventa"
    Private Const lRegion As String = "RibbonButton267"
    Private Const nTabla As String = "impresorasfiscales"

    Private myConn As New MySqlConnection
    Private ds As New DataSet
    Private dt As New DataTable

    Private strSQL As String = "select * from jsconcatimpfis where id_emp = '" & jytsistema.WorkID & "' order by codigo"
    ...
    End Sub
    Private Sub jsControlArcImpresoraFiscal_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        dt = Nothing
        ds = Nothing
    End Sub

    Private Sub jsControlArcImpresoraFiscal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"codigo", "tipoimpresora", "maquinafiscal", ""}
        Dim aNombres() As String = {"Código", "Tipo Impresora", "Nº Serial Máquina Fiscal", ""}
        Dim aAnchos() As Long = {70, 200, 150, 90}
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        Dim f As New jsControlArcImpresoraFiscalMovimientos
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        Dim nReg As Integer = NumeroDeRegistrosEnTabla(myConn, "jsvenencpos", " codcaj = '" & dt.Rows(Posicion).Item("codigo") & "' ")
        If nReg > 0 Then
            MensajeCritico(lblInfo, "(" & nReg & ") CAJA P.V. NO ELIMINABLE...")
        Else
            ...
            If sRespuesta = vbYes Then
                ...
                EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsconcatimpfis", strSQL, aCampos, aString, Posicion)
            End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Dim Campos() As String = {"codigo", "maquinafiscal"}
        Dim Nombres() As String = {"Código ", "Serial impresora fiscal"}
        Dim Anchos() As Long = {100, 200, 100}
        f.Buscar(dt, Campos, Nombres, Anchos, Me.BindingContext(ds, nTabla).Position, "Impresoras fiscales...")
