...
Public Class jsControlArcCorredoresCestaTicketMovimientosTipo
    ...
    Private Sub IniciarTXT()
        ft.iniciarTextoObjetos(Transportables.tipoDato.Cadena, txtCodigo, txtNombre)
        ft.iniciarTextoObjetos(Transportables.tipoDato.Numero, txtComision, txtImpuesto)
    ...
    Private Sub AsignarTXT(ByVal nPosicion As Integer)
        With dtLocal.Rows(nPosicion)
            ...
            txtComision.Text = ft.FormatoNumero(.Item("com_corredor"))
            txtImpuesto.Text = ft.FormatoNumero(.Item("com_cliente"))
        End With
    End Sub
