...
Public Class jsControlArcImpresoraFiscal
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Integer = {70, 200, 150, 90}
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If nReg > 0 Then
            ft.MensajeCritico("(" & nReg & ") CAJA P.V. NO ELIMINABLE...")
        Else
            ...
            If ft.PreguntaEliminarRegistro() = Windows.Forms.DialogResult.Yes Then
                ...
                Posicion = EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsconcatimpfis", strSQL, aCampos, aString, Posicion)
            End If
