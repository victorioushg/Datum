...
Public Class jsControlArcAlmacenes
    Private Const sModulo As String = "Almacenes"
    ...
    Public Property Seleccionado() As String
        ...
        End Set
    End Property
    Public Sub Cargar(ByVal Mycon As MySqlConnection, ByVal TipoCarga As Integer, Optional ExcluirAlmacenes As String = "")

        ' 0 = show() ; 1 = showdialog()

        myConn = Mycon

        If ExcluirAlmacenes.Trim = "" Then
            strSQL = "select * from jsmercatalm where id_emp = '" & jytsistema.WorkID & "' order by codalm"
        Else
            strSQL = "select * from jsmercatalm where " _
                & " codalm not in (" & ExcluirAlmacenes & ") AND " _
                & " id_emp = '" & jytsistema.WorkID & "' order by codalm"
        End If
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If NumeroDeRegistrosEnTabla(myConn, "jsmertramer", " almacen = '" & dt.Rows(Posicion).Item("codalm") & "' ") > 0 Then
            MensajeCritico(lblInfo, "ALMACEN NO ELIMINABLE...")
        Else
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        f.Buscar(dt, Campos, Nombres, Anchos, Me.BindingContext(ds, nTabla).Position, "Almacenes...")
