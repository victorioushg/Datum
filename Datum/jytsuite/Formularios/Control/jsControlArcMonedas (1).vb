...
Public Class jsControlArcMonedas
    ...
    Private strSQL As String = "select * from jsconcatmon order by codigo"
    ...
    Private Sub IniciarGrilla()
        Dim aCampos() As String = {"codigo", "nombre", "abreviatura", "pais"}
        Dim aNombres() As String = {"Moneda", "Nombre", "Abreviatura", "País"}
        Dim aAnchos() As Long = {70, 200, 80, 200}
        Dim aAlineacion() As Integer = {AlineacionDataGrid.Centro, AlineacionDataGrid.Izquierda, AlineacionDataGrid.Izquierda, AlineacionDataGrid.Izquierda}
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        '    EliminarRegistros(myConn, lblInfo, ds, nTabla, "jsconctatar", strSQL, aCampos, aString, Posicion)
        'End If
