...
Public Class jsControlArcIVA
    ...
    Private strSQL As String = " SELECT * FROM jsconctaiva " _
                               & " WHERE fecha IN (SELECT MAX(fecha) " _
                               & "                  FROM jsconctaiva " _
                               & "                  WHERE fecha <= '" & ft.FormatoFechaMySQL(jytsistema.sFechadeTrabajo) & "' GROUP BY tipo) " _
                               & " order by tipo "
    ...
    Private Sub AsignarTooltips()
        'Menu Barra 
        ft.colocaToolTip(C1SuperTooltip1, btnAgregar, btnEditar, btnSeleccionar, btnSalir)
    End Sub
