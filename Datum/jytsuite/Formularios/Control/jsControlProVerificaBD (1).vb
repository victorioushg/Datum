...
Public Class jsControlProVerificaBD
    ...
    Private Sub ActualizarContabilidad()
        Dim aTablas() As String = {"jscotcatcon|codcon.cadena30|descripcion.cadena150|nivel.entero2|marca.cadena|DEB00.doble19|CRE00.doble19|DEB01.doble19|CRE01.doble19|DEB02.doble19|CRE02.doble19|DEB03.doble19|CRE03.doble19|DEB04.doble19|CRE04.doble19|DEB05.doble19|CRE05.doble19|DEB06.doble19|CRE06.doble19|DEB07.doble19|CRE07.doble19|DEB08.doble19|CRE08.doble19|DEB09.doble19|CRE09.doble19|DEB10.doble19|CRE10.doble19|DEB11.doble19|CRE11.doble19|DEB12.doble19|CRE12.doble19|EJERCICIO.cadena5|ID_EMP.cadena2", _
    ...
    Private Sub ActualizarBancos()
        ...
        Dim aTablas() As String = {"jsbancatban|CODBAN.cadena5|NOMBAN.cadena50|CTABAN.cadena50|AGENCIA.cadena20|DIRECCION.cadena100|TELEF1.cadena20|TELEF2.cadena20|FAX.cadena20|titulo.cadena5|CONTACTO.cadena50|EMAIL.cadena50|WEBSITE.cadena50|COMISION.doble6|FECHACREA.fecha|SALDOACT.doble19|CODCON.cadena30|FORMATO.cadena2|ESTATUS.entero2|MONEDA.cadena5|ID_EMP.cadena2", _
                                   ...
                                   "jsbanenccaj|CAJA.cadena2|NOMCAJA.cadena50|CODCON.cadena50|SALDO.doble19|EJERCICIO.cadena5|ID_EMP.cadena2", _
    ...
    Private Sub ActualizarNomina()
        ...
        Dim aTablas() As String = {"jsnomcatcam|CODIGO.cadena5|CAMPO.cadena20|DESCRIPCION.cadena50|TIPO.entero2|LONGITUD.entero4|DECIMALES.entero2|ID_EMP.cadena2", _
                                   "jsnomcatcon|CODNOM.cadena5|CODCON.cadena5|NOMCON.cadena50|tipo.cadena|cuota.cadena5|CONJUNTO.cadena5|CONDICION.cadena250|FORMULA.cadena250|AGRUPADOPOR.cadena50|CODPRO.cadena15|CONCEPTO_POR_ASIG.cadena5|CODIGOCON.cadena30|ESTATUS.cadena|ID_EMP.cadena2", _
                                   ...
                                   "jsnomfecnom|CODNOM.cadena5|DESDE.fecha|HASTA.fecha|TIPONOM.cadena|ID_EMP.cadena2|", _
                                   "jsnomhisdes|CODNOM.cadena5|CODTRA.cadena15|CODCON.cadena5|HASTA.fecha|IMPORTE.doble19|codpre.cadena5|num_cuota.entero2|ASIENTO.cadena10|FECHASI.fecha|GRUPO1.cadena5|GRUPO2.cadena5|GRUPO3.cadena5|PORCENTAJE_ASIG.doble6|CODIGOCON.cadena30|EJERCICIO.cadena5|ID_EMP.cadena2", _
                                   ...
                                   "jsnomtrades|CODNOM.cadena5|CODTRA.cadena15|CODCON.cadena5|IMPORTE.doble19|PORCENTAJE_ASIG.doble6|ID_EMP.cadena2", _
                                   ...
                                   "jsnomformula|formula.cadena50|parametros.cadena150|descripcion.cadena250|ID_EMP.cadena2", _
                                   "jsnomencnom|CODNOM.cadena5|DESCRIPCION.cadena30|TIPONOM.entero2|ULT_DESDE.fecha|ULT_HASTA.fecha|CODCON.cadena30|ID_EMP.cadena2", _
                                   "jsnomrennom|CODNOM.cadena5|CODTRA.cadena10|CODCON.cadena30|ID_EMP.cadena2"}
        ...
        Dim aIndices() As String = {"jsnomcatcam|PRIMARY|`codigo`, `campo`,  `id_emp`", _
                                    ...
                                    "jsnomformula|PRIMARY|`formula`,`id_emp`", _
    ...
    Private Sub ActualizarPuntosdeVenta()
        ...
        Dim aTablas() As String = {"jsvenaudpos|FECHA.fecha|CODVEN.cadena5|CODSUP.cadena5|TIPOMOV.cadena2|NUMDOC.cadena30|HORA.cadena10|EJERCICIO.cadena5|ID_EMP.cadena2", _
                                   ...
                                   "jsvenencpos|NUMFAC.cadena15|NUMSERIAL.cadena15|tipo.entero2|EMISION.fecha|CODCLI.cadena15|nomcli.cadena250|RIF.cadena15|NIT.cadena15|COMEN.cadena150|ALMACEN.cadena5|VENCE.fecha|REFER.cadena15|CODCON.cadena30|ITEMS.entero4|CAJAS.doble10|KILOS.doble10|TOT_NET.doble19|PORDES.doble6|DESCUEN.doble19|CARGOS.doble19|IMP_IVA.doble19|TOT_FAC.doble19|NUMERO_RETENCION_IVA.cadena15|NOMBRE_RETENCION_IVA.cadena15|MONTO_RETENCION_IVA.doble19|FECHA_RETENCION_IVA.fecha|CONDPAG.entero2|TIPOCRE.cadena|ASIENTO.cadena15|FECHASI.fecha|ESTATUS.entero2|TARIFA.cadena|CODCAJ.cadena5|CODVEN.cadena5|IMPRESA.entero2|ejercicio.cadena5|ID_EMP.cadena2", _
    ...
    Private Sub ActualizarProduccion()
        ...
        Dim aTablas() As String = {"jsfabencfor|CODFOR.cadena5|CODART.cadena15|DESCRIP_1.cadena250|DESCRIP_2.cadena250|CANTIDAD.doble10|UNIDAD.cadena3|PESO_TOTAL.doble10|ALMACEN_DESTINO.cadena5|TOTAL_NETO.doble19|TOTAL_INDIRECTOS.doble19|TOTAL.doble19|COMENTARIOS.memo|FECHA.fecha|ESTATUS.entero2|ID_EMP.cadena2", _
                                   "jsfabrenfor|CODFOR.cadena5|RENGLON.cadena5|ITEM.cadena15|DESCRIP.cadena150|CANTIDAD.doble10|UNIDAD.cadena3|PESO_RENGLON.doble10|COSTOU.doble19|TOTREN.doble19|ALMACEN_SALIDA.cadena5|RESIDUAL.entero2|SUBENSAMBLE.entero2|PORCENTAJE.doble6|ID_EMP.cadena2", _
                                   "jsfabadjfor|CODFOR.cadena5|RENGLON.cadena5|CAMINO.cadena250|ID_EMP.cadena2", _
                                   "jsfabfijfor|CODFOR.cadena5|CODCOSTO.cadena5|TITULO.cadena150|PORCENTAJE.doble6|MONTOFIJO.doble19|ID_EMP.cadena2", _
                                   "jsfabcatfij|CODCOSTO.cadena5|TITULO.cadena150|PORCENTAJE.doble6|MONTOFIJO.doble19|ID_EMP.cadena2"}

        ProcesarTablas(aTablas)

        Dim aIndices() As String = {"jsfabencfor|PRIMARY|`CODFOR`, `ID_EMP`", _
                                    "jsfabrenfor|PRIMARY|`CODFOR`, `RENGLON`, `ITEM`,`ID_EMP`", _
    ...
    Private Sub ActualizarControlDeGestiones()
        Dim aTablas() As String = {"jsconcatdes|CODDES.cadena5|DESCRIP.cadena50|PORDES.doble6|INICIO.fecha|FIN.fecha|CODVEN.cadena5|TIPO.cadena|ID_EMP.cadena2", _
                                   ...
                                   "jsconctatab|CODIGO.cadena5|DESCRIP.cadena250|MODULO.cadena5|ID_EMP.cadena2", _
                                   ...
                                   "jsconregaud|ID_USER.cadena5|MAQUINA.cadena100|FECHA.fechahora|GESTION.entero2|MODULO.cadena250|TIPOMOV.entero2|NUMDOC.cadena250|EJERCICIO.cadena5|ID_EMP.cadena2", _
                                   ...
                                   "jsconcatimpfis|codigo.cadena5|tipoimpresora.entero2|maquinafiscal.cadena30|ultima_factura.cadena15|ultima_notacredito.cadena15|ultimo_docnofiscal.cadena15|puerto.cadena5|EN_USO.entero|ID_EMP.cadena2", _
                                   "jsconencconsulta|CONSULTA_ID.cadena15|CONSULTA_NOMBRE.cadena250|USUARIO_ID.cadena15|REPORTE_ID.entero6|ID_EMP.cadena2", _
                                   "jsconrenconsulta|CONSULTA_ID.cadena15|OBJETO_ID.cadena30|OBJETO_TEXTO.cadena250|ID_EMP.cadena2", _
                                   "jsconcausas_notascredito|CODIGO.cadena5|DESCRIPCION.cadena50|CR.entero2|VALIDA_DOCUMENTOS.entero2|ORIGEN.cadena3|FORMAPAGO.cadena2|NUMPAG.cadena15|NOMPAG.cadena30", _
                                   "jsconregistroefectivo|CAJA.cadena5|CAJERO.cadena5|FECHA.fechahora|NUM_CONTROL_INTERNO.cadena20|NUM_CONTROL_FISCAL.cadena20|MONTO.cadena10|CANTIDAD.enterolargo10|ID_EMP.cadena2"}
        ...
        Dim aIndices() As String = {"jsconcontadores|PRIMARY|`gestion`,`modulo`, `codigo`, `id_emp`", _
                                    ...
                                    "jsconcatimpfis|PRIMARY|`codigo`,`id_emp`", _
                                    "jsconencconsulta|PRIMARY|`CONSULTA_ID`,`ID_EMP`", _
                                    "jsconrenconsulta|PRIMARY|`CONSULTA_ID`,`OBJETO_ID`,`ID_EMP`", _
                                    "jsconcausas_notascredito|PRIMARY|`CODIGO`,`ORIGEN`", _
                                    "jsconregistroefectivo|PRIMARY|`CAJA`,`CAJERO`, `NUM_CONTROL_INTERNO`,`NUM_CONTROL_FISCAL`,`MONTO`,`ID_EMP`"}

        ProcesarIndices(aIndices)


        If Not ExisteFunction(myConn, lblInfo, jytsistema.WorkDataBase, "SPLIT_STR") Then _
            EjecutarSTRSQL(myConn, lblInfo, " CREATE FUNCTION SPLIT_STR( " _
                & "  x VARCHAR(255), " _
                & "  delim VARCHAR(12), " _
                & "  pos INT " _
                & ")" _
                & "RETURNS VARCHAR(255) " _
