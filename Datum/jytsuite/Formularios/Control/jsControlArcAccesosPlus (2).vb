...
Public Class jsControlArcAccesosPlus
    ...
    Private Sub AbrirAuditoria()
        ...
        strSQL = " SELECT a.fecha, a.maquina, a.id_user, b.nombre, a.numdoc , ELT(a.tipomov,  " _
            ...
            & " WHERE " _
            & " a.tipomov > 2 AND " _
            & " a.fecha >=  '" & FormatoFechaMySQL(DateAdd(DateInterval.Month, -1, jytsistema.sFechadeTrabajo)) & "' AND " _
    ...
    Private Sub IniciarGrilla()
        ...
        Dim aAnchos() As Long = {180, 150, 70, 300, 200, 150}
    ...
    Private Sub btnBuscar_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscar.Click
        ...
        Dim Anchos() As Long = {180, 150, 70, 300, 200, 150}
        f.Text = Me.Text
